...
Para conocer las prácticas recomendadas sobre FC e iSCSI, consulta https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Informe técnico de NetApp 4080: Prácticas recomendadas para SAN moderno"^].
