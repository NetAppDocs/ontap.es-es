...
image::../media/scrn-en-drw-fcoe-dual-2p-targ.gif[scrn en drw fcoe doble 2p targ]
...
image::../media/scrn_en_drw_fcoe-end-to-end.png[scrn en drw fcoe end]
...
image::../media/scrn_en_drw_fcoe-mixed.png[scrn en drw fcoe mixto]
...
image::../media/scrn_en_drw_fcoe-mixed-ethernet.png[scrn en drw fcoe mixta ethernet]
