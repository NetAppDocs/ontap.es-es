...
image::../media/scrn-en-drw-fcoe-dual-2p-targ.png[Iniciador FCoE a destino FC]
...
image::../media/scrn_en_drw_ip_storage_protocol.png[Combinación de FCoE y los protocolos de almacenamiento IP]
