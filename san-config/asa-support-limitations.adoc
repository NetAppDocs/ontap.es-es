...
NOTE: Estas limitaciones se aplican a los sistemas ASA. Si tienes un sistema ASA r2 (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 o ASA C30), consulta link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["Límites del almacenamiento del sistema ASA R2"^].
...
Para obtener más información sobre los puertos persistentes, consulta link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Informe técnico de NetApp 4080: Prácticas recomendadas para SAN moderno"^].
