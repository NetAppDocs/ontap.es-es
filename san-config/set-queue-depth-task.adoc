...
+
El valor predeterminado para `num_cmd_elems` tiene 200. El valor máximo es 2,048.
...
* El valor predeterminado para `scsi_max_qdepth` tiene 8. El valor máximo es 255.
+
...
* El valor predeterminado para `max_fcp_reqs` tiene 512. El valor máximo es 1024.
+
