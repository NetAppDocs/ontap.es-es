...
* Los clústeres de origen y destino deben tener SnapMirror síncrono link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["licencia instalada"]. Esta licencia se incluye con link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"].
...
* link:https://docs.netapp.com/us-en/ontap/nas-audit/enable-disable-auditing-svms-task.html["La redirección de registros de auditoría debe estar habilitada en el clúster de destino"].
* link:https://docs.netapp.com/us-en/ontap/nas-audit/commands-modify-auditing-config-reference.html?q=audit+log+destination+path["La ruta de destino del registro de auditoría de la SVM de origen debe crearse en el clúster de destino"].
...
| Relaciones de SnapMirror Cloud | ONTAP 9.12.1 | A partir de ONTAP 9.12.1, cuando se migra una SVM con relaciones de SnapMirror Cloud, el clúster de destino debe tener el link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["Licencia de SnapMirror Cloud"] instalado y debe tener suficiente capacidad disponible para admitir el desplazamiento de capacidad de los volúmenes que se reflejan al cloud. 
