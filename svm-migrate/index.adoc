...
* Los clústeres de origen y destino deben tener SnapMirror Synchronous link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["licencia instalada"].
...
| Relaciones de SnapMirror Cloud | ONTAP 9.12.1 | A partir de ONTAP 9.12.1, cuando se migra una SVM con relaciones de SnapMirror Cloud, el clúster de destino debe tener instalada la licencia de SnapMirror Cloud y debe tener suficiente capacidad disponible para admitir el traslado de la capacidad de los volúmenes que se están reflejando en el cloud. 
