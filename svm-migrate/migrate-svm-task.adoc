...
A partir de ONTAP 9.19.1, se admiten configuraciones FC y FC-NVMe de conexión directa para determinados sistemas AFF, ASA r2 y FAS. Las configuraciones de conexión directa no admiten la migración SMV.
