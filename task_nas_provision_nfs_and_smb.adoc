...
| System Manager Classic (ONTAP 9.7 y anterior) | https://docs.netapp.com/us-en/ontap-sm-classic/nas-multiprotocol-config/index.html["Información general de la configuración de varios protocolos de SMB y NFS"^] 
