...
* link:nfs-admin/case-sensitivity-file-directory-multiprotocol-concept.html["Obtenga información sobre la distinción entre mayúsculas y minúsculas de los nombres de archivos y directorios en un entorno multiprotocolo ONTAP NFS"]
