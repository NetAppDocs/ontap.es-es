...
.Requisitos previos
Los volúmenes de origen y destino deben crearse en clústeres con una relación entre iguales con SVM. Para obtener más información, consulte https://["Relaciones entre iguales de clústeres y SVM"].
...
. En el clúster de destino, instale la licencia de SnapLock, inicialice la instancia de ComplianceClock y, si utiliza una versión de ONTAP anterior a 9.10.1, cree un agregado de SnapLock.
