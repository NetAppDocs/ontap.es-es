...
No
 a| 
Sí, a partir de ONTAP 9.8. Obtenga más información sobre xref:FabricPool en agregados de SnapLock Enterprise.
...
Volúmenes de FlexGroup
 a| 
Sí, a partir de ONTAP 9.11.1. Más información acerca de xref:FlexGroup volumes[Compatibilidad de SnapLock en volúmenes de FlexGroup].
 a| 
Sí, a partir de ONTAP 9.11.1. Más información acerca de xref:FlexGroup volumes[Compatibilidad de SnapLock en volúmenes de FlexGroup].
...
Configuraciones de MetroCluster
 a| 
Sí, a partir de ONTAP 9.3. Obtenga más información sobre xref:compatibilidad con MetroCluster.
 a| 
Sí, a partir de ONTAP 9.3. Obtenga más información sobre xref:compatibilidad con MetroCluster.
