...
Con SnapLock, tú guardas archivos e instantáneas en almacenamiento WORM y estableces períodos de retención para los datos protegidos por WORM. El almacenamiento WORM de SnapLock utiliza la tecnología de instantáneas de NetApp y puede aprovechar la replicación SnapMirror y las copias de seguridad SnapVault como tecnología base para ofrecer protección de recuperación de copias de seguridad de los datos. Más información sobre el almacenamiento WORM: link:https://www.netapp.com/pdf.html?item=/media/6158-tr4526.pdf["Almacenamiento WORM conforme a la normativa con SnapLock de NetApp: TR-4526"^].
...
SnapLock es una función de ONTAP basada en licencia. Una sola licencia le permite utilizar SnapLock en un modo de cumplimiento estricto, para satisfacer mandatos externos como la Regla 17a-4(f) de la SEC, y un modo empresarial más flexible, para cumplir con las regulaciones internas obligatorias para la protección de activos digitales. Las licencias SnapLock son parte de la link:../system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"] paquete de software.
...
A nivel de archivo
 a| 
El administrador de cumplimiento puede eliminarlo mediante un procedimiento de "eliminación privilegiada" auditado.
