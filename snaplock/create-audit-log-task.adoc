...
A partir de ONTAP 9.10.1, ya no se crea un agregado de SnapLock. Debe utilizar la opción -snaplock-type a. link:https://docs.netapp.com/us-en/ontap/snaplock/create-snaplock-volume-task.html["Crear explícitamente un volumen SnapLock"] Especificando Compliance o Enterprise como tipo SnapLock.
