...
summary: Puedes usar los comandos volume file fingerprint start y volume file fingerprint dump para ver información clave sobre archivos y volúmenes, incluido el tipo de archivo, la fecha de caducidad del volumen y así sucesivamente. 
---
= Verificar la configuración de ONTAP SnapLock
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
