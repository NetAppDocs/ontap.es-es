...
** Obtenga más información sobre `security login role create` y `security login create` en el https://docs.netapp.com/us-en/ontap-cli/security-login-role-create.html["Referencia de comandos de la ONTAP"^].
