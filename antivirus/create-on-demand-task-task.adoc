...
+
Para obtener una lista completa de opciones, consulte link:https://docs.netapp.com/us-en/ontap-cli-9131/vserver-vscan-on-demand-task-create.html["referencia de comandos"^].
