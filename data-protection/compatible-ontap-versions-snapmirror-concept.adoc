...
NOTE: ONTAP 9.16.0 es una excepción a la regla de solo nube porque proporciona soporte paralink:https://docs.netapp.com/us-en/asa-r2/learn-more/software-support-limitations.html["Sistemas ASA r2"] .  El signo más (+) después de la versión de lanzamiento indica una versión compatible tanto con ASA r2 como con la nube.  Los sistemas ASA r2 admiten relaciones SnapMirror únicamente con otros sistemas ASA r2.
