...
* Puede utilizar SVM DR para migrar un SVM que no cumpla con las restricciones indicadas para link:../svm-migrate/index.html["Migración de SVM (movilidad de datos de SVM)"].
