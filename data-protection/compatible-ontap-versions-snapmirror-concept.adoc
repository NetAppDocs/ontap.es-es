...
* La replicación es compatible en una sola dirección de una versión anterior de ONTAP a una versión posterior de ONTAP, por ejemplo, de ONTAP 9.11.1 a ONTAP 9.12.1
