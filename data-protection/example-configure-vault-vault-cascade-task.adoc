...
summary: Un ejemplo mostrará en términos concretos cómo puede configurar las relaciones de replicación paso a paso. Puede utilizar la implementación en cascada vault-vault configurada en el ejemplo para retener más de 251 instantáneas etiquetadas como “my-weekly”. 
---
...
[role="lead"]
Un ejemplo mostrará en términos concretos cómo puede configurar las relaciones de replicación paso a paso. Puede utilizar la implementación en cascada vault-vault configurada en el ejemplo para retener más de 251 instantáneas etiquetadas «semanalmente».
...
* Ha configurado instantáneas en el clúster de origen con las etiquetas de SnapMirror «diario», «semanal» y «mensual».
...
* La política ««SnapVault_secondary» conserva 7 copias snapshot diarias, 52 semanales y 180 mensuales en el clúster de destino secundario.
* La ««política SnapVault_terciaria» conserva 250 snapshots semanales en el clúster de destino terciario.
