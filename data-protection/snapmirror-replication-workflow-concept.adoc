...
summary: Para cada tipo de relación de protección de datos SnapMirror, el flujo de trabajo es el mismo. Creas un volumen de destino, creas un programa de trabajo, especificas una política, creas e inicializas la relación. 
---
