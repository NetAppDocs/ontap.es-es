...
La siguiente tabla muestra la interacción del `snapmirror create `-identity-preserve` y la `snapmirror policy create` opción -descartar configuraciones de red':
