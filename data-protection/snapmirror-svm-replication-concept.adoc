...
** La asociación de volúmenes con políticas de snapshot definidas por el usuario y por el sistema no se copia en la SVM de destino.
...
Habilitar IPsec
 a| 
No es compatible a partir de ONTAP 9.19.1.
