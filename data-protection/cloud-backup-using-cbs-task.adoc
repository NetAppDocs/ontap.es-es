...
.Pasos
. En el Administrador del sistema, haga clic en *Protección > Descripción general*, luego desplácese a la sección *Copia de seguridad y recuperación de BlueXP *.
...
. Haga clic en *Conectar y habilite la copia de seguridad y recuperación de BlueXP *.
