...
LSM no es adecuado para clústeres de parejas de alta disponibilidad únicas y debe configurarse para varios clústeres de parejas de alta disponibilidad, configurando el LSM entre el nodo con el volumen raíz y otro nodo desde un par de alta disponibilidad diferente.
