...
[role="lead"]
A partir de ONTAP 9.9.1, puedes usar _SnapMirror cloud_ cuando quieras trasladar tus flujos de trabajo de protección de datos a la nube. En lugar de las arquitecturas tradicionales de copia de seguridad en cinta, puedes usar el almacenamiento de objetos como repositorio alternativo para la conservación y el archivado de datos a largo plazo. Puedes usar proveedores como Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID u ONTAP S3 como tu almacén de objetos en la nube.

A partir de ONTAP 9.9.1, puedes usar System Manager para hacer copias de seguridad y restaurar tus datos.
