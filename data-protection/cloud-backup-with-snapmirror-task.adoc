...
* El backup en el cloud de SnapMirror admite relaciones de abanico. Esto significa que los backups de SnapMirror se pueden crear de manera simultánea en dos almacenes de objetos diferentes.
