...
summary: Una política de instantáneas especifica cuándo crear instantáneas, cuántas copias conservar y cómo nombrarlas. Una política de instantáneas puede contener hasta cinco planificaciones de trabajos. 
---
