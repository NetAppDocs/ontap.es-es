...
. Seleccione image:icon_kabob.gif["alt=Opciones de menú"] Junto al origen de la relación y elija *Test Failover*.
...
. Haga clic en image:icon_add_blue_bg.gif["alt=Menú Agregar Compartir"] Y elige *Share*.
...
.Pasos
. En el clúster de destino, seleccione *Protección > Relaciones*.
. Seleccione image:icon_kabob.gif["alt=Opciones de menú"] Junto a la fuente de la relación y elija *Limpiar prueba de failover*.
