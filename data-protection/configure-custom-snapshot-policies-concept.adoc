...
summary: Una política de instantáneas define cómo crea instantáneas el sistema. La política especifica cuándo crear instantáneas, cuántas copias conservar y cómo nombrarlas. 
---
