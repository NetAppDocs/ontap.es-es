...
---
= Convierta una relación de tipo DP existente a XDP en ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Puede resultarle útil conservar una copia[`snapmirror show` del resultado del comando para realizar un seguimiento de la existencia de la configuración de relaciones. Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli//SnapMirror-show.html[`snapmirror show`^] en la referencia de comandos de ONTAP.
...
----
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-quiesce.html[`snapmirror quiesce`^] en la referencia de comandos de ONTAP.
...
----
+
Obtenga más información sobre el comando LINK:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-break.html[`snapmirror-break`^] en la referencia de comandos ONTAP .
...
----
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-delete.html[`snapmirror-delete`^] en la referencia de comandos de ONTAP.
...
----
+
Para mejorar el tiempo de resincronización, puede usar la `-quick-resync` opción, pero debe saber que se pueden perder los ahorros de eficiencia del almacenamiento. Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/SnapMirror-resync.html#parameters.html[`snapmirror resync`^] en la referencia de comandos de ONTAP.
