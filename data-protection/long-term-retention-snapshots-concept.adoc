...
Las instantáneas de retención a largo plazo solo están disponibles para configuraciones de FlexVol SnapMirror . No se pueden crear instantáneas de retención a largo plazo para configuraciones de FlexGroup SnapMirror .
