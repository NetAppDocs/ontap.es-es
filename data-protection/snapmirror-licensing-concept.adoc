...
+
Si compraste tu sistema antes de junio de 2019 con un paquete Premium o Flash, puedes descargar una clave de licencia de NetApp para obtener la licencia sincrónica necesaria de SnapMirror desde el sitio de soporte de NetApp: https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["Claves de licencia"^].
