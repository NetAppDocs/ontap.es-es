...
| Protección autónoma contra ransomware | ONTAP 9.19.1 | Después de actualizar a ONTAP 9.19.1 RC y habilitar ARP en los volúmenes que forman parte de relaciones sincrónicas de SnapMirror, la relación podría experimentar un breve estado de desincronización. Esta condición es temporal y la relación se resincronizará automáticamente sin que tengas que hacer nada. 
