...
| Protección autónoma contra ransomware | ONTAP 9.19.1 | Después de actualizar a ONTAP 9.19.1 RC y activar ARP en volúmenes que forman parte de relaciones síncronas de SnapMirror, la relación puede experimentar un breve estado de desincronización. Este estado es temporal y la relación debería resincronizarse automáticamente sin ninguna intervención. 
