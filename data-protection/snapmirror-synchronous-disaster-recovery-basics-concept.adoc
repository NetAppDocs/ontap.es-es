...
| Protección autónoma contra ransomware | ONTAP 9.19.1 | Si habilitas ARP en volúmenes que forman parte de SnapMirror synchronous o de SnapMirror active sync relationships después de la actualización, la relación pasará brevemente a un estado de desincronización. Esta condición es temporal y la relación debería resincronizarse automáticamente sin intervención. Para obtener más información, consulta link:../anti-ransomware/use-cases-restrictions-concept.html["Casos de uso y consideraciones sobre la protección de Ransomware autónoma"]. 
