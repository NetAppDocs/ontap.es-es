...
| Protección autónoma contra ransomware | ONTAP 9.19.1 | Después de actualizar a ONTAP 9.19.1 RC y activar ARP, es posible que la relación experimente un breve estado de desincronización. Este estado es temporal y la relación debería resincronizarse automáticamente sin ninguna intervención. 
