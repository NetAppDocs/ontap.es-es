...
---
= Soluciona problemas de hardware con ONTAP System Manager
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.2+| Plataforma 11+| Admitido en System Manager en la versión de ONTAP... 


| 9.18.1 | 9.17.1 | 9.16.1 | 9.15.1 | 9.14.1 | 9.13.1 | 9.12.1 | 9.11.1 | 9.10.1 | 9.9.1 | 9,8 (solo modo de vista previa) 
...
Sí
 ...
 a| 
&#42; Instala las últimas versiones de los parches para ver estos dispositivos.
...
| ONTAP 9.10.1 y 9.9.1 | Nexus 3232C Cisco Nexus 9336C-FX2 de Cisco 
