...
El vínculo se copia en el portapapeles. Puede pegar el vínculo en un archivo o en una ventana del explorador.
 ...
 a| 
Haga clic en image:icon-pin-blue.png["icono de pasador azul"].
 a| 
El panel en el que se muestran los resultados está anclado de manera que permanece visible cuando se trabaja en otro panel.
 ...
 a| 
Haga clic en image:icon-x-close.png["X icono para cerrar el panel"].
 a| 
...
Cuando se visualizan todos los resultados de la búsqueda, se ordenan alfabéticamente. Para ordenar los resultados, haga clic en image:icon_filter.png["menú de filtrado"] y seleccionando cómo desea ordenar los resultados.
