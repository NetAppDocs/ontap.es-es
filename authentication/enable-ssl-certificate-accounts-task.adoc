...
+
Para obtener una sintaxis de comando completa, consulte la link:https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html["Páginas manuales de ONTAP por versión"].
