...
NOTE: A partir de ONTAP 9.19.1, debes introducir un código TOTP válido o un código scratch para eliminar tu clave secreta TOTP usando la CLI. No puedes eliminar tu clave secreta TOTP usando la API de REST.
