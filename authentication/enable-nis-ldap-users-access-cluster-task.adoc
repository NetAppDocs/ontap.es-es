...
====
+
El siguiente comando crea una configuración de dominio NIS en '`engData`' de SVM. El dominio NIS '`nisdomain`' está activo en la creación y se comunica con un servidor NIS con la dirección IP 192,0.2,180.
