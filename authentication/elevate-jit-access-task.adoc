...
* La elevación de privilegios JIT solo se admite para usuarios que utilicen contraseña, nsswitch o autenticación de dominio para iniciar sesión. La autenticación multifactor (MFA) no es compatible con la elevación de privilegios JIT.
