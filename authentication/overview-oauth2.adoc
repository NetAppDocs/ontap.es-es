...
summary: 'A partir de ONTAP 9.14, tienes la opción de controlar el acceso a tus clústeres ONTAP mediante el marco Open Authorization (OAuth 2.0). Puedes configurar esta función usando cualquiera de las interfaces administrativas de ONTAP, incluidas la CLI de ONTAP, System Manager y la API de REST de ONTAP. Sin embargo, las decisiones de autorización y control de acceso de OAuth 2.0 solo se pueden aplicar cuando un cliente accede a ONTAP usando la API de REST de ONTAP.' 
---
...
[role="lead"]
A partir de ONTAP 9.14, tienes la opción de controlar el acceso a tus clústeres ONTAP mediante el marco Open Authorization (OAuth 2.0). Puedes configurar esta función usando cualquiera de las interfaces administrativas de ONTAP, incluidas la CLI de ONTAP, System Manager y la API de REST de ONTAP. Sin embargo, las decisiones de autorización y control de acceso de OAuth 2.0 solo se pueden aplicar cuando un cliente accede a ONTAP usando la API de REST de ONTAP.
