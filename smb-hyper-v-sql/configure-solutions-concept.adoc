...
summary: Puedes usar recursos compartidos de archivos SMB 3.0 y posteriores de disponibilidad continua para almacenar archivos de máquinas virtuales Hyper-V o bases de datos de sistema de Microsoft SQL Server y bases de datos de usuario en volúmenes que residen en SVMs, mientras al mismo tiempo ofreces operaciones sin interrupciones tanto para eventos planificados como no planificados. 
---
...
* NetApp Backup and Recovery protege las máquinas virtuales independientes de Hyper-V, las instancias de clúster de FCI y las máquinas virtuales aprovisionadas por System Center Virtual Machine Manager (SCVMM) alojadas en recursos compartidos CIFS.
+
Para obtener información sobre cómo proteger las cargas de trabajo de Hyper-V con NetApp Backup and Recovery, consulta https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-hyperv-protect-overview.html["Descripción general de la protección de cargas de trabajo de Hyper-V"].
