...
+
Para información sobre cómo usar SnapManager con configuraciones de Hyper-V sobre SMB, consulta la  https://docs.netapp.com/us-en/snapmanager-hyper-v/index.html["Documentación de SnapManager for Hyper-V"].
