...
summary: Debes tener en cuenta ciertos requisitos de red y LIF de datos al crear configuraciones de SQL Server o Hyper-V sobre SMB para operaciones sin interrupciones. 
---
