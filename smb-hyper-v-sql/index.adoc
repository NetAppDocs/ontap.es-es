...
summary: 'Las funciones de ONTAP te permiten habilitar operaciones sin interrupciones para dos aplicaciones de Microsoft a través del protocolo SMB: Microsoft Hyper-V y Microsoft SQL Server.' 
---
