...
Para obtener información adicional sobre la tecnología ONTAP y la interacción con servicios externos, consulta estos Technical Reports (TRs): ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["Informe técnico de NetApp 4172: Prácticas recomendadas de Microsoft Hyper-V mediante SMB 3.0 con ONTAP"^]
