...
summary: Debes conocer ciertos conceptos que se requieren para entender cómo Remote VSS es usado por los servicios de backup con Hyper-V sobre configuraciones SMB. 
---
