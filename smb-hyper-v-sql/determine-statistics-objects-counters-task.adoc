...
|===
+
Obtenga más información sobre `statistics catalog` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=statistics+catalog["Referencia de comandos de la ONTAP"^].
