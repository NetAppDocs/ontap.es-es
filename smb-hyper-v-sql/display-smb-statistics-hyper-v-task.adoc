...
* link:https://docs.netapp.com/us-en/ontap-cli-9121/statistics-show.html["se muestran las estadísticas"^]
* link:https://docs.netapp.com/us-en/ontap-cli-9121/statistics-start.html["inicio de las estadísticas"^]
* link:https://docs.netapp.com/us-en/ontap-cli-9121/statistics-stop.html["se detienen las estadísticas"^]
