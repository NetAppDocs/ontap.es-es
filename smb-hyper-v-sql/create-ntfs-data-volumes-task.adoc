...
Existen parámetros opcionales que se pueden usar para personalizar un volumen de datos. Para obtener más información acerca de cómo personalizar volúmenes, consulte link:link:../volumes/index.html["Gestión de almacenamiento lógico"].
