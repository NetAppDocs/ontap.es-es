...
summary: Incluso si configuras máquinas virtuales de almacenamiento con Hyper-V y SQL Server sobre configuraciones SMB para tener LIFs en cada nodo de un clúster, durante las operaciones diarias, algunos LIFs podrían moverse a puertos en otro nodo. Debes verificar el estado de los LIF y tomar las acciones correctivas necesarias. 
---
