...
summary: Para garantizar el éxito de las operaciones no disruptivas para Hyper-V y SQL Server sobre SMB, los volúmenes deben crearse con el estilo de seguridad NTFS. Dado que el estilo de seguridad del volumen raíz se aplica por defecto a los volúmenes creados en la máquina virtual de almacenamiento, el estilo de seguridad del volumen raíz debe establecerse en NTFS. 
---
