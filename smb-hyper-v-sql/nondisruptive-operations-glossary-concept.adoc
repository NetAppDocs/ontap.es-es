...
summary: Existen ciertos conceptos sobre las operaciones no disruptivas que debes comprender antes de configurar tu solución Hyper-V o SQL Server sobre SMB. 
---
