...
summary: Puedes aplicar una actualización de firmware a los dispositivos compatibles de tu clúster, como discos, estanterías de discos, el service processor o el Baseboard Management Controller. 
---
...
[role="lead"]
A partir de ONTAP 9.9.1, si estás registrado con link:https://docs.netapp.com/us-en/active-iq/["Asesor digital"^], puedes recibir alertas en System Manager que te informan cuando hay actualizaciones de firmware pendientes para los dispositivos compatibles, como disco, estantes de disco, el service processor (SP) o el Baseboard Management Controller (BMC) en el clúster.

Si estás ejecutando ONTAP 9.8 o no estás registrado en Digital Advisor, ve al sitio de soporte de NetApp para descargar actualizaciones de firmware.
...
.Pasos
Sigue el procedimiento adecuado según tu versión de ONTAP y si estás registrado en Digital Advisor.
