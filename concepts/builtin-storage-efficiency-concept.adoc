...
En las siguientes plataformas, la eficiencia de almacenamiento está habilitada de forma predeterminada únicamente en los volúmenes con Thin-Provisioning existentes que ya tenían habilitada la eficiencia de almacenamiento antes de actualizar a ONTAP 9.15.1 o una versión posterior. Puedes habilitar la eficiencia de almacenamiento en volúmenes recién creados usando la CLI de ONTAP o el método de API de REST de ONTAP. Los datos que se migran usando volume move o la tecnología SnapMirror se convierten a compresión en línea de 32k solo si la compresión estaba habilitada en la plataforma original.
