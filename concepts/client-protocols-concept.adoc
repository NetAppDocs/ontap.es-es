...
summary: ONTAP es compatible con los principales protocolos de cliente estándar del sector, incluidos NFS, SMB, FC, FCoE, iSCSI, NVMe y S3. 
---
= Conoce los protocolos de cliente de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
