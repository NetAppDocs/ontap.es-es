...
[NOTE]
====
Las SVM se denominaban anteriormente «'vServers'». Aún verá ese término en la interfaz de línea de comandos (CLI) de ONTAP.
...
image::../media/volume-move.gif[movimiento de volúmenes]
