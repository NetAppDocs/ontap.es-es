...
. Asocie la configuración del cliente al Vserver. Consulte link:../nfs-config/enable-ldap-svms-task.html["Asocie la configuración del cliente LDAP con las SVM"]. Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli//vserver-services-name-service-ldap-create.html[`vserver services name-service ldap create`^] en la referencia de comandos de ONTAP.
...
----
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/security-login-rest-role-create.html[`security login rest-role create`^] en la referencia de comandos de ONTAP.

. Cree un grupo de usuarios LDAP con el comando security login y añada el nuevo rol personalizado para acceder al punto final de la API DE REST DE usuarios de S3. Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli//security-login-create.html[`security login create`^] en la referencia de comandos de ONTAP.
+
[listing]
----
