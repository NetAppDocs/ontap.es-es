...
Obtenga más información sobre `security certificate` las opciones de configuración adicionales en la link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=security+certificate["Referencia de comandos de la ONTAP"^]sección .
