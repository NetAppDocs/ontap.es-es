...
Al igual que otros protocolos como FC, iSCSI, NFS, NVMe_oF y SMB, S3 requiere la instalación de una licencia antes de poder usarse en ONTAP. La licencia de S3 es una licencia sin costo, pero debe instalarse en los sistemas que se actualicen a ONTAP 9.8. La licencia de S3 puede descargarse desde el link:https://mysupport.netapp.com/site/systems/master-license-keys/ontaps3["página de claves de licencia"^] en el sitio de soporte de NetApp.
