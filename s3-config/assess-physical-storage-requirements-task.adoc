...
Al crear un bucket de S3 en una SVM habilitada para S3, se crea un volumen FlexGroup link:../s3-config/architecture.html#automatic-flexgroup-sizing-with-ontap-9-14-1-and-later["se crea automáticamente"] para dar soporte al bucket. Puedes dejar que ONTAP seleccione los agregados subyacentes y los componentes FlexGroup automáticamente (el valor predeterminado) o puedes seleccionar los agregados subyacentes y los componentes FlexGroup tú mismo.
...
* https://www.netapp.com/pdf.html?item=/media/17251-tr4571a.pdf["Informe técnico de NetApp 4571-a: Mejores prácticas para los volúmenes ONTAP FlexGroup de NetApp"^]
