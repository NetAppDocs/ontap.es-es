...
La capacidad mínima del cubo está determinada por la plataforma ONTAP .

* 95 GB para plataformas locales.
* 1,6 GB para laboratorio bajo demanda.
...
La capacidad máxima del depósito está limitada al tamaño máximo de FlexGroup de 60 PB.



=== Número máximo de cubos

La cantidad máxima de depósitos es 1000 por volumen FlexGroup o 12 000 depósitos por clúster (utilizando 12 volúmenes FlexGroup ).
