...
+
Consulte link:https://docs.netapp.com/us-en/ontap-cli-9141/vserver-object-store-server-show.html["modificación de bucket object-store-server de vserver"] si quiere más información.
