...
A partir de ONTAP 9.19.1, puedes usar condiciones para imponer escrituras condicionales para cargas de objetos y eliminaciones condicionales para eliminaciones de objetos. Las escrituras y eliminaciones condicionales ofrecen una forma de evitar sobrescrituras o eliminaciones no intencionadas de objetos.
...
----
A partir de ONTAP 9.19.1, puedes usar condiciones para imponer escrituras condicionales para cargas de objetos y eliminaciones condicionales para eliminaciones de objetos. El siguiente ejemplo crea una condición de declaración de política de bucket para imponer escrituras condicionales para bucket1:
