...
* FlexClone technology (volúmenes, archivos y LUN)
...
* Políticas de QoS anidadas
+
link:../performance-admin/policy-group-assignment-restrictions.html["Restricciones de asignación de grupos de políticas de QoS"]
...
Características adicionales
 a| 
* El traslado de volúmenes es compatible con los volúmenes individuales que componen un volumen de FlexGroup.
...
* Nivel de nube de FabricPool (link:../s3-config/index.html["solo S3 nativo"])
* FabricPool nivel local (link:../s3-multiprotocol/index.html["Solo volúmenes NAS"])
* link:../flexcache/supported-unsupported-features-concept.html#supported-features["Volúmenes de FlexCache"] (a partir de ONTAP 9.18.1)

 a| 
* No se admite el traslado de volúmenes para los volúmenes FlexGroup que son utilizados por los buckets de S3.
* FPolicy
* Qtrees
* Cuotas
