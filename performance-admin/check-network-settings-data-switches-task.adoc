...
summary: Aunque debes mantener la misma configuración de MTU en tus clientes, servidores y sistemas de almacenamiento, los dispositivos de red intermedios, como las NIC y los switches, deben configurarse con sus valores máximos de MTU para asegurarte de que el rendimiento no se vea afectado. 
---
