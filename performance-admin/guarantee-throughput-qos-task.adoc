...
|===
| Compatibilidad con cargas de trabajo | ONTAP 9,3 | ONTAP 9,4 a 9,7 | ONTAP 9,8 a 9.13.0 | ONTAP 9.13.1 y versiones posteriores 
...
| Volumen FlexGroup | no | sí | sí | sí 


| qtrees ^1^ | no | no | sí | sí 


| Varias cargas de trabajo por grupo de políticas | no | sí | sí | sí 


| Grupos de políticas no compartidos | no | sí | sí | sí 
|===
