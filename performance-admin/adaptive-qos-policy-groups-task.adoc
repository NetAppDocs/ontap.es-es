...
summary: Puedes usar un grupo de políticas de QoS adaptable para escalar automáticamente un techo o suelo de rendimiento al tamaño del volumen, manteniendo la proporción de IOPS por TB o GB a medida que cambia el tamaño del volumen. Eso es una ventaja significativa cuando gestionas cientos o miles de cargas de trabajo en una implementación grande. 
---
