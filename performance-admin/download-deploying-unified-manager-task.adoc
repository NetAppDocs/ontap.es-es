...
summary: Para instalar el software, debes descargar el archivo de instalación del dispositivo virtual y luego usar un cliente de VMware vSphere para desplegar el archivo en un servidor VMware ESXi. El VA está disponible en un archivo OVA. 
---
