...
. Vaya a la https://["Matriz de interoperabilidad"] para verificar que tiene una combinación compatible de los siguientes componentes:
+
** Versión de ONTAP
...
[NOTE]
====
La http://["Matriz de interoperabilidad"] Enumera las configuraciones admitidas para Unified Manager.
