...
[role="lead"]
Puede revertir directamente su software ONTAP a solo una versión anterior a su versión actual de ONTAP .  Por ejemplo, si está ejecutando 9.15.1, no podrá revertir directamente a 9.13.1.  Primero debe volver a la versión 9.14.1 y luego realizar una reversión separada de 9.14.1 a 9.13.1.
...
NOTE: link:https://docs.netapp.com/us-en/ontap-afx/administer/revert-ontap.html["Sistemas de almacenamiento AFX"^]No se admite la reversión del software ONTAP .
