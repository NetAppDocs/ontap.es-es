...
* link:arp-warning-clear-revert.html["Responder a las advertencias de actividad anormal de la Protección autónoma contra ransomware"].




| ONTAP 9.19.1  a| 
* Si tienes algún SVM con configuraciones multivía activo-activo, debes link:delete-active-active-svms.html["eliminar las SVM"].
* Si has modificado la configuración predeterminada de cualquier grupo de políticas de QoS creado en ONTAP 9.19.1 o una versión posterior, debes link:modify-qos-policy-groups.html["restablecerlos"].
* Si has actualizado los volúmenes a ONTAP 9.19.1 y has añadido una segunda clave de acceso S3 a cualquier usuario, debes link:second-s3-access-key.html["elimina estas claves"].




| ONTAP 9.18.1  a| 
* Si se ha configurado la activación automática de ARP/AI como parte de una actualización a ONTAP 9.18.1, tendrás que link:anti-ransomware-disable-auto-enable.html["desactívela"].




| ONTAP 9.17.1  a| 
* Si has habilitado la función ONTAP ARP/AI para SAN, link:anti-ransomware-disable-san.html["desactívela"].
