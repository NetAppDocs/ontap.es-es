...
| ONTAP 9.18.1  a| 
* Si se ha configurado la activación automática para ARP como parte de una actualización de ONTAP 9.18.1, tendrás que link:anti-ransomware-disable-auto-enable.html["desactívela"].
