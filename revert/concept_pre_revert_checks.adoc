...
| ¿Está configurada la conexión troncal de sesiones de NFSv4,1 para ONTAP 9.12.1 o posterior? | xref:remove-nfs-trunking-task.html[Elimine la configuración de troncalización de sesión NFSv4,1] 
|===
