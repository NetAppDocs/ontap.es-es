...
summary: Antes de revertir ONTAP, debes verificar el estado del cluster, el estado del almacenamiento y la hora del sistema. También debes verificar que no hay trabajos ejecutándose en el cluster. 
---
...
** El quórum primario por anillo debe ser el mismo para todos los nodos.
+
Ten en cuenta que cada anillo puede tener un primario de quórum diferente.
