...
+
El `-version` La opción se refiere a la versión de ONTAP a la que está volviendo.  Por ejemplo, si está volviendo de 9,14 a 9,13, el valor correcto de la `-version` La opción es 9.13.
