...
+
Para obtener más información sobre cómo eliminar relaciones de distribución de carga, consulta link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["Cómo eliminar una relación de espejo con reparto de carga"].
