...
Si experimenta una conmutación al nodo de respaldo en el clúster secundario en la relación de SM-BC, el destino asíncrono de SnapMirror quedará en mal estado y deberá restaurar la protección manualmente, eliminando y volviendo a crear la relación con el extremo asíncrono de SnapMirror.
