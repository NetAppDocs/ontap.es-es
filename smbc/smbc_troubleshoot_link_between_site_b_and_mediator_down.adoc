...
[role="lead"]
Para comprobar la conexión del Mediador ONTAP, utilice el `snapmirror mediator show` comando. Si el estado de la conexión es inalcanzable y el sitio B no puede llegar al sitio B, tendrá una salida similar a la que se muestra a continuación. Siga los pasos de la solución para restaurar la conexión
