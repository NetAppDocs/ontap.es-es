...
....
.Causa:
La conmutación al respaldo planificada no se puede iniciar cuando hay una operación no disruptiva en curso, incluidos el movimiento de volúmenes, la reubicación de agregados y la conmutación al respaldo de almacenamiento.
