...
* Interfaz de red: Dirección y propiedades asignadas a un puerto de red físico. Quizás la conozca como interfaz lógica (LIF).
* *Pausa*: Una acción que detiene las operaciones. Antes de ONTAP 9.8, es posible que haya hecho referencia a _quiesce_ en otras versiones del Administrador del Sistema.
