...
+
Puedes ver y procesar `XML` registros de eventos de auditoría en aplicaciones de terceros que admiten el formato de archivo `XML`. Puedes usar herramientas de visualización XML para ver los registros de auditoría siempre que tengas el esquema XML y la información sobre las definiciones de los campos XML. Para más información sobre el esquema XML y las definiciones, consulta la https://library.netapp.com/ecm/ecm_get_file/ECMLP2875022["Referencia del esquema de auditoría de ONTAP"^].
