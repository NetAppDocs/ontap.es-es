...
summary: La ruta del objeto impresa en la etiqueta ObjectName para un registro de auditoría contiene el nombre del volumen entre paréntesis y la ruta relativa desde la raíz del volumen contenedor. Si quieres determinar la ruta completa del objeto auditado, incluida la ruta de unión, hay ciertos pasos que debes seguir. 
---
