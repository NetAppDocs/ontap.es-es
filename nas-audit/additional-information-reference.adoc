...
* https://www.netapp.com/pdf.html?item=/media/16326-tr-4191.pdf["Informe técnico de NetApp 4191: Guía de mejores prácticas para servicios de archivos de Windows para Clustered Data ONTAP 8.2"^]
+
