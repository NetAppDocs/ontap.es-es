...
summary: Puedes usar el carácter comodín para mostrar información sobre la seguridad de los archivos y las políticas de auditoría de todos los archivos y directorios bajo una ruta determinada o un volumen raíz. 
---
