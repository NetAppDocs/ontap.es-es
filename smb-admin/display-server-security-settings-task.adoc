...
summary: Puedes mostrar información sobre la configuración de seguridad del servidor SMB en tus máquinas virtuales de almacenamiento. Puedes usar esta información para verificar que la configuración de seguridad es correcta. 
---
