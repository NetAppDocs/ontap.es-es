...
summary: Añadir entradas de control de acceso DACL al descriptor de seguridad NTFS es el segundo paso en la configuración y aplicación de ACLs NTFS a un archivo o carpeta. Cada entrada identifica qué objeto tiene permitido o denegado el acceso, y define lo que el objeto puede o no puede hacer a los archivos o carpetas definidos en la ACE. 
---
