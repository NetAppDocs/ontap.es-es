...
Puede agregar uno o varios ACE al DACL del descriptor de seguridad.

Si el descriptor de seguridad contiene un DACL que tiene ACE existentes, el comando agrega el nuevo ACE al DACL. Si el descriptor de seguridad no contiene un DACL, el comando crea el DACL y le agrega el nuevo ACE.
