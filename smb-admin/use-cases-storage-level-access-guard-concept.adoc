...
summary: Storage-Level Access Guard proporciona seguridad adicional a nivel de almacenamiento, que no es visible desde el lado del cliente. Por lo tanto, no puede ser revocada por ninguno de los usuarios o administradores desde sus escritorios. Hay ciertos casos de uso en los que la capacidad de controlar el acceso a nivel de almacenamiento es beneficiosa. 
---
