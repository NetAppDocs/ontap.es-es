...
A partir de ONTAP 9.13.1, cuando ONTAP busca dominios de confianza durante las operaciones de asignación de nombres multidominio, lleva a cabo la detección de sitios para esos dominios de confianza y usa el sitio detectado para las búsquedas de controladores de dominio. Este comportamiento ayuda a garantizar que las búsquedas DNS SRV usen la información de sitio correcta para los controladores de dominio de los dominios de confianza. Si falla la detección de sitios de los dominios de confianza, ONTAP usa el sitio predeterminado del servidor SMB.
