...
summary: Puedes mostrar información detallada sobre los grupos restringidos que están definidos como objetos de política de grupo en Active Directory y que se aplican al servidor CIFS. 
---
