...
summary: Puedes mostrar información sobre qué tipo de usuarios se conectan a través de sesiones SMB. Esto puede ayudarte a asegurarte de que solo el tipo de usuario adecuado se conecta a través de sesiones SMB en la máquina virtual de almacenamiento. 
---
