...
summary: La creación de un descriptor de seguridad NTFS es el primer paso en la configuración y aplicación de listas de control de acceso NTFS a archivos y carpetas que residen dentro de máquinas virtuales de almacenamiento. Puedes asociar el descriptor de seguridad a la ruta del archivo o carpeta en una tarea de política. 
---
