...
summary: Para utilizar LDAP sobre SSL/TLS para proteger la comunicación de Active Directory, primero debes exportar una copia del certificado CA raíz autofirmado del servicio de certificados de Active Directory a un archivo de certificado y convertirlo en un archivo de texto ASCII. Este archivo de texto es utilizado por ONTAP para instalar el certificado en la máquina virtual de almacenamiento. 
---
