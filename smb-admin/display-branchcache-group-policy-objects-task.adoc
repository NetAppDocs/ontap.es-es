...
summary: Puedes mostrar información sobre la configuración de los objetos de política de grupo del servidor CIFS para determinar si los GPO de BranchCache están definidos para el dominio al que pertenece el servidor CIFS y, si es así, cuáles son los ajustes permitidos. También puedes determinar si los ajustes de los GPO de BranchCache se aplican al servidor CIFS. 
---
