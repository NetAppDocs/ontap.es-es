...
summary: La localización automática utiliza referencias automáticas de nodo SMB para aumentar el rendimiento del cliente SMB en máquinas virtuales de almacenamiento. Las referencias automáticas de nodo redirigen automáticamente al cliente solicitante a un LIF en el nodo SVM que aloja el volumen en el que residen los datos, lo que puede mejorar los tiempos de respuesta del cliente. 
---
