...
summary: Puedes activar o desactivar la enumeración basada en acceso en los recursos compartidos SMB para permitir o impedir que los usuarios vean recursos compartidos a los que no tienen permiso de acceso. 
---
