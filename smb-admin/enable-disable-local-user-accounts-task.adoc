...
summary: Puedes habilitar una cuenta de usuario local si quieres que el usuario pueda acceder a los datos contenidos en la máquina virtual de almacenamiento a través de una conexión SMB. También puedes deshabilitar una cuenta de usuario local si no quieres que ese usuario acceda a los datos de la SVM a través de SMB. 
---
