...
summary: Puedes mostrar la ruta del directorio inicial de un usuario SMB en la máquina virtual de almacenamiento, que puedes usar si tienes configuradas varias rutas del directorio inicial CIFS y quieres ver qué ruta contiene el directorio inicial del usuario. 
---
