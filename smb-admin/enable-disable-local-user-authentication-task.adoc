...
summary: Puedes activar o desactivar la autenticación de usuario local para el acceso SMB en máquinas virtuales de almacenamiento. El valor predeterminado es permitir la autenticación de usuario local, lo que resulta útil cuando la SVM no puede ponerse en contacto con un controlador de dominio o si decides no usar controles de acceso a nivel de dominio. 
---
