...
summary: Puedes ver información sobre los recursos compartidos SMB en tu SVM y realizar algunas tareas de gestión usando Microsoft Management Console. Antes de poder ver los recursos compartidos, necesitas conectar la MMC a la SVM. 
---
