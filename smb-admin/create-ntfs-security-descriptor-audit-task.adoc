...
summary: La creación de una política de auditoría del descriptor de seguridad NTFS es el primer paso en la configuración y aplicación de listas de control de acceso NTFS a archivos y carpetas que residen en SVM. Vas a asociar el descriptor de seguridad a la ruta del archivo o carpeta en una tarea de política. 
---
