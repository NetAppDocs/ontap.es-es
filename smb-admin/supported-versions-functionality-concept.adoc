...
summary: Server Message Block es un protocolo de compartición de archivos remoto utilizado por clientes y servidores de Microsoft Windows. Se admiten todas las versiones de SMB. Debes verificar que el servidor SMB de ONTAP admite los clientes y la funcionalidad requeridos en tu entorno. 
---
