...
summary: Puedes crear una configuración de directorio inicial utilizando el nombre de usuario de Windows y las variables de directorio inicial. Luego, los usuarios pueden conectarse a su directorio inicial usando recursos compartidos creados dinámicamente. 
---
