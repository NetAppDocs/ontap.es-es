...
summary: Existen comandos específicos de ONTAP para gestionar entradas de control de acceso DACL. Puedes agregar ACEs a DACLs NTFS en cualquier momento. También puedes gestionar DACLs NTFS existentes modificando, eliminando y mostrando información sobre ACEs en DACLs. 
---
