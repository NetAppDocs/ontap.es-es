...
summary: A partir de ONTAP 9, puedes configurar la firma y el sellado para activar la seguridad de sesión LDAP en las consultas a un servidor Active Directory. Debes configurar los ajustes de seguridad del servidor CIFS en la máquina virtual de almacenamiento para que se correspondan con los del servidor LDAP. 
---
