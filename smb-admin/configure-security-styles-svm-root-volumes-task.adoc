...
summary: Configuras el estilo de seguridad del volumen raíz de la máquina virtual de almacenamiento para determinar el tipo de permisos que se usan para los datos en el volumen raíz de la SVM. 
---
