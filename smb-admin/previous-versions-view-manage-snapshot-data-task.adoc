...
summary: Los usuarios de equipos cliente Windows pueden utilizar la pestaña Versiones anteriores de la ventana Propiedades de Windows para restaurar los datos almacenados en instantáneas sin necesidad de que intervenga el administrador de la máquina virtual de almacenamiento. 
---
