...
summary: Si tu configuración de BranchCache activa automáticamente el almacenamiento en caché en todos los recursos compartidos SMB de cada máquina virtual de almacenamiento, puedes modificar la configuración de BranchCache para dejar de almacenar automáticamente en caché el contenido de todos los recursos compartidos SMB. 
---
