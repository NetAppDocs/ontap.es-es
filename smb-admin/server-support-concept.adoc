...
summary: Puedes activar y configurar servidores SMB en máquinas virtuales de almacenamiento para permitir que los clientes SMB accedan a los archivos de tu clúster. 
---
