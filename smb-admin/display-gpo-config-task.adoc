...
summary: Puedes mostrar información sobre las configuraciones de objetos de directiva de grupo definidas en Active Directory y sobre las configuraciones de GPO aplicadas al servidor CIFS. 
---
