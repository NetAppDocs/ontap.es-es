...
summary: Puedes mostrar información detallada sobre las reglas de política de acceso central que están asociadas a las políticas de acceso central definidas en Active Directory. También puedes mostrar información sobre las reglas de política de acceso central que se aplican al servidor CIFS a través de los GPO de política de acceso central. 
---
