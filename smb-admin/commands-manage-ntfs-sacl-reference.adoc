...
summary: Existen comandos específicos de ONTAP para gestionar las entradas de control de acceso SACL. Puedes agregar ACEs a NTFS SACLs en cualquier momento. También puedes gestionar NTFS SACLs existentes modificando, eliminando y mostrando información sobre ACEs en SACLs. 
---
