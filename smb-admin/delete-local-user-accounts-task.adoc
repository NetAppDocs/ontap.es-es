...
summary: Puedes eliminar las cuentas de usuario locales de tu máquina virtual de almacenamiento si ya no son necesarias para la autenticación SMB local en el servidor CIFS o para determinar los derechos de acceso a los datos contenidos en tu SVM. 
---
