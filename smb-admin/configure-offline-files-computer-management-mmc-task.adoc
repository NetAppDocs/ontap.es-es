...
summary: Si quieres permitir que los usuarios almacenen archivos en caché localmente para usarlos sin conexión, puedes configurar la compatibilidad con archivos sin conexión usando la MMC de Administración de equipos. 
---
