...
summary: Los nombres compartidos del directorio inicial deben contener el nombre de usuario de Windows o la variable dinámica del nombre de usuario de UNIX. Debes tener en cuenta lo que ocurre con los nombres compartidos del directorio inicial estáticos existentes después de actualizar a una versión de ONTAP con el nuevo requisito. 
---
