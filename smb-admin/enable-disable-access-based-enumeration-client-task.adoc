...
summary: Puedes activar o desactivar la enumeración basada en acceso en los recursos compartidos SMB desde un cliente de Windows, lo que te permite configurar este recurso compartido sin necesidad de conectarte al servidor CIFS. 
---
