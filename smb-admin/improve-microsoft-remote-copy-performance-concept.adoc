...
summary: Microsoft Offloaded Data Transfer, también conocida como copia de datos descargados, permite transferencias directas de datos dentro de o entre dispositivos de almacenamiento compatibles sin transferir los datos a través del host. 
---
