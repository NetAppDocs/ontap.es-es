...
summary: Puedes cambiar la clave del servidor BranchCache modificando la configuración de BranchCache en la máquina virtual de almacenamiento y especificando una clave de servidor diferente. 
---
