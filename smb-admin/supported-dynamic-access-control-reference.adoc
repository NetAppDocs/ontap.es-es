...
summary: Si quieres usar el control de acceso dinámico en tu servidor CIFS, necesitas entender cómo ONTAP admite la funcionalidad de control de acceso dinámico en entornos de Active Directory. 
---
