...
summary: Puedes verificar la política de auditoría para confirmar que los archivos o carpetas de la máquina virtual de almacenamiento a la que aplicaste la política de seguridad tienen la configuración de seguridad de auditoría deseada. 
---
