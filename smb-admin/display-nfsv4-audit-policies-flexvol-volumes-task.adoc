...
summary: Puedes mostrar información sobre las políticas de auditoría de NFSv4 en los volúmenes de FlexVol usando la CLI de ONTAP, incluyendo cuáles son los estilos de seguridad y los estilos de seguridad efectivos, qué permisos se aplican e información sobre las listas de control de acceso del sistema. Puedes usar los resultados para validar tu configuración de seguridad o para solucionar problemas de auditoría. 
---
