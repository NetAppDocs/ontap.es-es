...
summary: Puedes vaciar todos los hashes almacenados en caché del almacén de hashes de BranchCache en la máquina virtual de almacenamiento. Esto puede ser útil si cambiaste la configuración de BranchCache en la sucursal. Por ejemplo, si recientemente reconfiguraste el modo de almacenamiento en caché de distribuido a alojado, querrás vaciar el almacén de hashes. 
---
