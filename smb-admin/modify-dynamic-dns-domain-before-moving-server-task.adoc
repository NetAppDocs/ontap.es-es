...
summary: Si quieres que el servidor DNS integrado en Active Directory registre dinámicamente los registros DNS del servidor SMB en DNS cuando muevas el servidor SMB a otro dominio, debes modificar DNS dinámico en la máquina virtual de almacenamiento antes de mover el servidor SMB. 
---
