...
summary: Los oplocks tradicionales y los oplocks de alquiler permiten a un cliente SMB en determinados escenarios de uso compartido de archivos realizar el almacenamiento en caché del lado del cliente de la información de lectura anticipada, escritura posterior y bloqueo. Un cliente puede entonces leer o escribir en un archivo sin recordarle regularmente al servidor que necesita acceso al archivo en cuestión. Esto mejora el rendimiento al reducir el tráfico de red. 
---
