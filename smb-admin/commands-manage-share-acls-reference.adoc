...
summary: Necesitas conocer los comandos para gestionar las listas de control de acceso SMB, lo que incluye crearlas, mostrarlas, modificarlas y eliminarlas. 
---
