...
summary: Puedes configurar las opciones del servidor SMB en cualquier momento después de haber creado un servidor SMB en una máquina virtual de almacenamiento. 
---
