...
summary: El conjunto predeterminado de usuarios y grupos locales se crea cuando se crea un servidor CIFS, y se asocian a la máquina virtual de almacenamiento que aloja el servidor CIFS. Los administradores de SVM pueden crear usuarios y grupos locales en cualquier momento. Debes tener en cuenta lo que ocurre con los usuarios y grupos locales cuando eliminas el servidor CIFS. 
---
