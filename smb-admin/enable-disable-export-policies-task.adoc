...
summary: Puedes activar o desactivar las políticas de exportación para el acceso SMB en máquinas virtuales de almacenamiento. Usar políticas de exportación para controlar el acceso SMB a los recursos es opcional. 
---
