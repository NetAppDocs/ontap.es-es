...
summary: Hay varios pasos que debes realizar para aplicar políticas de auditoría a archivos y carpetas NTFS cuando usas la CLI de ONTAP. Primero, creas un descriptor de seguridad NTFS y agregas SACLs al descriptor de seguridad. Luego creas una política de seguridad y agregas tareas de política. Después aplicas la política de seguridad a una máquina virtual de almacenamiento. 
---
