...
summary: Puedes activar o desactivar ODX en máquinas virtuales de almacenamiento. El valor predeterminado es activar la compatibilidad con la copia de datos descargados ODX si SMB 3.0 también está activado. 
---
