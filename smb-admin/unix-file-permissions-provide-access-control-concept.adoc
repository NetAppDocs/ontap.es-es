...
summary: 'Un volumen FlexVol puede tener uno de los tres tipos de estilo de seguridad: NTFS, UNIX o mixto. Puedes acceder a los datos a través de SMB independientemente del estilo de seguridad. Sin embargo, se necesitan permisos de archivo UNIX adecuados para acceder a los datos con seguridad efectiva UNIX.' 
---
