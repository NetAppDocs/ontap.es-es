...
[role="lead"]
Si desea que los clientes SMB se conecten al servidor SMB utilizando un alias, puede crear una lista de alias NetBIOS o puede agregar alias NetBIOS a una lista existente de alias NetBIOS.
