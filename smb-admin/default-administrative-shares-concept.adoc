...
summary: Cuando creas un servidor CIFS en tu máquina virtual de almacenamiento, se crean automáticamente recursos compartidos administrativos predeterminados. Debes comprender cuáles son esos recursos compartidos predeterminados y cómo se utilizan. 
---
