...
---
= Activar BranchCache en nuevos recursos compartidos SMB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Paso
. Crea un recurso compartido SMB habilitado para BranchCache:
+
[source, cli]
----
vserver cifs share create -vserver <SVM_name> -share-name <share_name> -path <path> -share-properties branchcache[,...]
----
. Verifica que la propiedad de recurso compartido BranchCache esté configurada en el recurso compartido SMB:
+
[source, cli]
----
