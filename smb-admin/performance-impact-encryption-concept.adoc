...
summary: Cuando las sesiones SMB utilizan cifrado SMB, todas las comunicaciones SMB hacia y desde clientes Windows experimentan un impacto en el rendimiento, que afecta tanto a los clientes como al servidor. 
---
