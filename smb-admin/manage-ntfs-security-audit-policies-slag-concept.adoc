...
summary: Puedes gestionar la seguridad de archivos NTFS, las políticas de auditoría NTFS y Storage-Level Access Guard en máquinas virtuales de almacenamiento mediante la CLI. 
---
