...
summary: Si solo tienes clientes CIFS en tu entorno y tu máquina virtual de almacenamiento se configuró como un sistema de almacenamiento multiprotocolo, debes tener al menos una cuenta de Windows que tenga privilegios de root para acceder a los archivos de la SVM. De lo contrario, no puedes administrar la SVM porque no tienes suficientes derechos de usuario. 
---
