...
summary: BranchCache fue desarrollado por Microsoft para permitir el almacenamiento en caché de contenido en ordenadores locales a los clientes que lo solicitan. La implementación de ONTAP de BranchCache puede reducir la utilización de la red de área amplia y proporcionar un tiempo de respuesta de acceso mejorado cuando los usuarios de una sucursal acceden a contenido almacenado en máquinas virtuales de almacenamiento usando SMB. 
---
