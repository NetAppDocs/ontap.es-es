...
summary: Si has configurado previamente BranchCache pero no quieres que la máquina virtual de almacenamiento siga proporcionando contenido en caché, puedes eliminar la configuración de BranchCache en el servidor CIFS. Debes saber qué sucede cuando eliminas la configuración. 
---
