...
summary: Puedes mostrar información detallada sobre las políticas centrales de acceso definidas en Active Directory. También puedes mostrar información sobre las políticas centrales de acceso que se aplican al servidor CIFS a través de objetos de política de grupo. 
---
