...
summary: Ten cuidado de asignar nombres de usuario únicos cuando crees directorios iniciales compartidos utilizando las variables de nombre de usuario de Windows o nombre de usuario de UNIX para generar recursos compartidos de forma dinámica. El nombre del recurso compartido se asigna a tu nombre de usuario. 
---
