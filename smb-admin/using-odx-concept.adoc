...
+
La función de copia de datos descargados de ODX admite operaciones de copia iniciadas desde un sistema operativo invitado de Hyper-V. El sistema operativo invitado debe ser compatible con ODX y utilizar discos virtuales SCSI respaldados por almacenamiento SMB o SAN compatible con ODX. Los discos virtuales IDE no admiten la copia de datos descargados de ODX. El almacenamiento de origen y el de destino deben estar en el mismo clúster.

+
Para obtener más información, consulta link:use-cases-odx-concept.html["Casos de uso de ODX en servidores SMB de ONTAP"].
