...
summary: Puedes mostrar una lista de todos los grupos locales configurados en el clúster o en una máquina virtual de almacenamiento especificada. Esta información puede ser útil cuando solucionas problemas de acceso a archivos a los datos contenidos en la SVM o problemas de derechos de usuario en la SVM. 
---
