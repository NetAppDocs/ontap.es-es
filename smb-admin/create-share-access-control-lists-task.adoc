...
summary: Configurar los permisos de recursos compartidos mediante la creación de listas de control de acceso para recursos compartidos SMB te permite controlar el nivel de acceso a un recurso compartido para usuarios y grupos. 
---
