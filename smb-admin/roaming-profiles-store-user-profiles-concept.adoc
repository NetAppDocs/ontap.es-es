...
summary: ONTAP admite el almacenamiento de perfiles de itinerancia de Windows en un servidor CIFS asociado a la máquina virtual de almacenamiento. Configurar perfiles de itinerancia de usuario ofrece ventajas al usuario, como la disponibilidad automática de recursos independientemente de dónde inicie sesión. Los perfiles de itinerancia también simplifican la administración y gestión de los perfiles de usuario. 
---
