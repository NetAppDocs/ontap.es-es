...
summary: Puedes mostrar información sobre las configuraciones de BranchCache en máquinas virtuales de almacenamiento, que puedes usar al verificar una configuración o al determinar los ajustes actuales antes de modificar una configuración. 
---
