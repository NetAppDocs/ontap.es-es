...
summary: Existen ciertas directrices que debes tener en cuenta antes de aplicar políticas de directorio de archivos en el destino de recuperación de desastres de la máquina virtual de almacenamiento en una configuración de descarte de ID si la configuración de la política de directorio de archivos utiliza usuarios o grupos locales en el descriptor de seguridad o en las entradas DACL o SACL. 
---
