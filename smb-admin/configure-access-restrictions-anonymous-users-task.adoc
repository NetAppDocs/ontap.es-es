...
summary: Por defecto, un usuario anónimo, no autenticado, puede acceder a cierta información en la red. Puedes usar una opción del servidor SMB para configurar restricciones de acceso para el usuario anónimo. 
---
