...
A partir de ONTAP 9.13.1, ONTAP también realiza el descubrimiento de sitios para los dominios de confianza y utiliza el sitio detectado al localizar los controladores de dominio de esos dominios. Esto ayuda a garantizar que las búsquedas DNS SRV utilicen la información correcta del sitio para los controladores de dominio de los dominios de confianza. Si falla el descubrimiento de sitios para un dominio de confianza, ONTAP recurre al sitio predeterminado del servidor SMB.
