...
summary: Puedes verificar la configuración de seguridad de los archivos para confirmar que los archivos o carpetas de la máquina virtual de almacenamiento a la que aplicaste la política de seguridad tienen la configuración deseada. 
---
