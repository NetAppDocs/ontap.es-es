...
* En la versión de ONTAP anterior a la versión 9,6, no se pueden modificar los volúmenes existentes para la compatibilidad con utf8mb4; debe crear un volumen listo para utf8mb4 y después migrar los datos con las herramientas de copia basadas en cliente.
+
