...
summary: Aunque no todos los objetos de directiva de grupo son aplicables a tus máquinas virtuales de almacenamiento habilitadas para CIFS, las SVM pueden reconocer y procesar el conjunto pertinente de GPO. 
---
