...
summary: Si tienes recursos que tienen ACL aplicadas con ACE de control de acceso dinámico y desactivas el control de acceso dinámico en la máquina virtual de almacenamiento, debes eliminar las ACE de control de acceso dinámico antes de poder gestionar las ACE de control de acceso no dinámico en ese recurso. 
---
