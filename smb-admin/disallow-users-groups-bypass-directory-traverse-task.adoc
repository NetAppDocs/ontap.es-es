...
summary: Si no quieres que un usuario recorra todos los directorios de la ruta a un archivo porque no tiene permisos sobre el directorio recorrido, puedes eliminar el privilegio SeChangeNotifyPrivilege de los usuarios o grupos SMB locales en storage virtual machines. 
---
