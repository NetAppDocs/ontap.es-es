...
summary: La configuración de la opción de usuario UNIX invitado significa que los usuarios que inician sesión desde dominios no fiables se asignan al usuario UNIX invitado y pueden conectarse al servidor CIFS. De forma alternativa, si quieres que falle la autenticación de los usuarios de dominios no fiables, no debes configurar el usuario UNIX invitado. El valor predeterminado es no permitir que los usuarios de dominios no fiables se conecten al servidor CIFS. 
---
