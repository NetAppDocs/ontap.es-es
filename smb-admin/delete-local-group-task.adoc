...
summary: Puedes eliminar un grupo local de la máquina virtual de almacenamiento si ya no es necesario para determinar los derechos de acceso a los datos asociados a esa SVM o si ya no es necesario para asignar derechos de usuario de SVM a los miembros del grupo. 
---
