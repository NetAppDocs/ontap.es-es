...
summary: Puedes activar o desactivar los usuarios y grupos locales para el acceso SMB en máquinas virtuales de almacenamiento. La funcionalidad de usuarios y grupos locales está activada por defecto. 
---
