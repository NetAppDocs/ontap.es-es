...
summary: Antes de crear una SVM configurada como destino de recuperación ante desastres en la que no se conserva la identidad, debes saber cómo se gestionan los ajustes de seguridad del servidor SMB en la SVM de destino. 
---
