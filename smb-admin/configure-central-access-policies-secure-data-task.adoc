...
summary: Hay varios pasos que debes seguir para proteger el acceso a los datos en el servidor CIFS utilizando políticas de acceso central, incluida la habilitación del control de acceso dinámico en el servidor CIFS, la configuración de políticas de acceso central en Active Directory, la aplicación de las políticas de acceso central a los contenedores de Active Directory con GPO y la habilitación de GPO en el servidor CIFS. 
---
