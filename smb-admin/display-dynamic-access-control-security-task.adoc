...
summary: Puedes mostrar información sobre la seguridad de control de acceso dinámico en volúmenes NTFS y en datos con seguridad efectiva NTFS en volúmenes de estilo de seguridad mixto. Esto incluye información sobre ACEs condicionales, ACEs de recursos y ACEs de política de acceso central. Puedes usar los resultados para validar tu configuración de seguridad o para solucionar problemas de acceso a archivos. 
---
