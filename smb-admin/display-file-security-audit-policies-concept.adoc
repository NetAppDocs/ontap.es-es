...
summary: Puedes mostrar información sobre la seguridad de archivos en archivos y directorios contenidos dentro de volúmenes en máquinas virtuales de almacenamiento. Puedes mostrar información sobre las políticas de auditoría en volúmenes FlexVol. Si está configurado, puedes mostrar información sobre la configuración de seguridad Storage-Level Access Guard y Dynamic Access Control en volúmenes FlexVol. 
---
