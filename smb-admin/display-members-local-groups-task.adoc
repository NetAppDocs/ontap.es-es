...
summary: Puedes mostrar una lista de todos los miembros de los grupos locales configurados en el clúster o en una máquina virtual de almacenamiento especificada. Esta información puede ser útil cuando solucionas problemas de acceso a archivos o problemas de derechos de usuario. 
---
