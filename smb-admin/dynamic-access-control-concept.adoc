...
summary: Hay ciertas consideraciones que debes tener en cuenta al utilizar el control dinámico de acceso y las políticas de acceso centralizado para proteger archivos y carpetas en servidores CIFS. 
---
