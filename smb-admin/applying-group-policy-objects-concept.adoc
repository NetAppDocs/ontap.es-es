...
summary: Tu servidor SMB es compatible con los objetos de directiva de grupo, un conjunto de reglas conocidas como atributos de política de grupo que se aplican a los equipos en un entorno de Active Directory. Puedes usar los objetos de directiva de grupo para gestionar de forma centralizada la configuración de todas las máquinas virtuales de almacenamiento del clúster que pertenezcan al mismo dominio de Active Directory. 
---
