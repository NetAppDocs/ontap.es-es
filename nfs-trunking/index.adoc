...
summary: A partir de ONTAP 9.14.1, los clientes de NFS que ejecuten v4.1 o versiones posteriores pueden aprovechar la funcionalidad de session trunking para abrir múltiples conexiones al servidor NFS, aumentando así la velocidad de transferencia de datos y proporcionando resiliencia mediante multipathing. 
---
