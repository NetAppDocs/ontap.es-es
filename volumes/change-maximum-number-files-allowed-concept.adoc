...
---
= El número predeterminado y máximo de archivos permitidos para los volúmenes de ONTAP FlexVol
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:++https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/FAQ_-_ONTAP_default_and_maximum_number_of_files_(inodes)++["Base de conocimientos de NetApp : Preguntas frecuentes: Número máximo y predeterminado de archivos (inodos) de ONTAP"^]
