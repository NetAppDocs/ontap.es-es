...
---
= Recomendaciones para mover volúmenes ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* A partir de ONTAP 9.15.1, mover volúmenes de un sistema A400 a un sistema A70, A90 o A1K puede causar problemas de mayor latencia de lectura. Para obtener más detalles y acciones recomendadas, consulte la link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/FS_Issues/CONTAP-556247["Base de conocimientos de NetApp : CONTAP-556247 - Compresión/descompresión lenta en volúmenes después de ser trasladados de A400 a A70, A90 y A1K"^].
