...
summary: Las notificaciones de cuotas son mensajes que se envían al sistema de gestión de eventos y también se configuran como trampas SNMP. 
---
= Notificaciones de cuotas de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
