...
---
= Reubicar un volumen raíz de ONTAP en nuevos agregados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se produce un reinicio del nodo durante la reubicación del volumen raíz, lo que termina cualquier sesión SSH activa.
