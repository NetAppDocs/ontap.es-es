...
---
= Gestiona manualmente las operaciones de eficiencia de volumen de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puede usar `volume efficiency show` el comando con `schedule` como valor para `-fields` la opción para ver la programación asignada a los volúmenes.
