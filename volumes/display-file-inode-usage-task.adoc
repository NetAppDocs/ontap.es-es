...
summary: Determina si necesitas aumentar el número de inodos de tus volúmenes FlexVol para evitar que alcancen su límite de archivos. 
---
= Determina el uso de archivos y nodos de información para un volumen ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
