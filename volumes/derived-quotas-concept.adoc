...
summary: Una cuota impuesta como resultado de una cuota por defecto, en lugar de una cuota explícita, se denomina cuota derivada. 
---
= Conoce las cuotas derivadas de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
