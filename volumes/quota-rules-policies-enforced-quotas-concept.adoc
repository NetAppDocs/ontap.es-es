...
summary: Las cuotas se definen en reglas de cuotas específicas para FlexVol volumes. Estas reglas de cuotas se reúnen en una política de cuotas para una máquina virtual de almacenamiento y se activan en cada volumen de la SVM. 
---
= Conoce las cuotas, reglas de cuotas y políticas de cuotas de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
