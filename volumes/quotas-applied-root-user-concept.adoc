...
summary: El usuario raíz en clientes UNIX está sujeto a cuotas de árbol, pero no a cuotas de usuario o grupo. Esto permite al usuario raíz realizar acciones en nombre de otros usuarios que de otro modo se verían impedidas por una cuota. 
---
= Aprende cómo se aplican las cuotas de ONTAP al usuario raíz
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
