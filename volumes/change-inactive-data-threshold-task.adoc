...
Consulte la página de manual para obtener información adicional acerca de link:https://docs.netapp.com/us-en/ontap-cli-9131/volume-efficiency-inactive-data-compression-modify.html#description["modificar la compresión de datos inactivos"].
