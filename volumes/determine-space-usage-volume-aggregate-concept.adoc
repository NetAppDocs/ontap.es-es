...
---
= Determina el uso de espacio en un volumen o agregado ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/Space_Usage["Base de conocimientos de NetApp : Uso del espacio"^]
