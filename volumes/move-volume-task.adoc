...
summary: Mueve un volumen FlexVol a un agregado, nodo o ambos diferentes dentro de la misma máquina virtual de almacenamiento para equilibrar la capacidad de almacenamiento. 
---
