...
---
= Conoce los informes de cuotas de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Consulta qué cuotas de ONTAP están en vigor usando el informe de cuotas
...
== Utiliza el informe de cuotas de ONTAP para determinar qué cuotas limitan las escrituras en un archivo específico
