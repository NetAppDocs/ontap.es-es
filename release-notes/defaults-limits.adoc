...
| Protección de ransomware autónoma (ARP) | ARP/AI se activa automáticamente por defecto en todos los volúmenes nuevos después de un periodo de gracia de 12 horas en las plataformas compatibles. | ONTAP 9.18.1 
