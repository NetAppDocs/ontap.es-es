...
| Mirroring con carga compartida | Cuando se crea una relación de reflejo de uso compartido de carga, el SVM de destino no puede tener un límite de almacenamiento habilitado. | ONTAP 9.16.1 
