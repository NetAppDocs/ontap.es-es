...
A partir de ONTAP 9.17.1P5, Autonomous Ransomware Protection es compatible con Hyper-V, KVM y los hipervisores OpenStack.
 ...
 a| 
xref:../anti-ransomware/index.html[Actualizaciones de instantáneas de Autonomous Ransomeware Protection]
 a| 
ONTAP introduce varias actualizaciones a las instantáneas ARP.
