...
| Actualizar | Descripción 
 ...
 a| 
xref:../anti-ransomware/index.html[Soporte adicional de hipervisor]
 a| 
A partir de ONTAP 9.17.1P5, Autonomous Ransomware Protection es compatible con Hyper-V, KVM y los hipervisores OpenStack.



 a| 
xref:../anti-ransomware/index.html[Actualizaciones de las instantáneas de Autonomous Ransomware Protection]
 a| 
ONTAP incorpora varias actualizaciones a las instantáneas ARP/AI.
