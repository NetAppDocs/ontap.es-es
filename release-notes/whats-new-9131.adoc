...
* xref:../anti-ransomware/support-arpai.html#multi-admin-verification-with-arp-ai-protected-volumes[Funcionalidad de verificación multiadministrador con protección autónoma frente a ransomware]
...
A partir de ONTAP 9.12.1, System Manager está integrado con la consola de NetApp . Obtenga más información sobre xref:../concepts/sysmgr-integration-console-concept.html[Integración de System Manager con la consola de NetApp] .
