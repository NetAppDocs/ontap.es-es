...
| xref:../snaplock/snapshot-lock-concept.html[Bloqueo de copias snapshot a prueba de manipulaciones] | Puede usar System Manager para bloquear una copia Snapshot en un volumen que no sea de SnapLock, a fin de brindar protección contra ataques de ransomware. 
