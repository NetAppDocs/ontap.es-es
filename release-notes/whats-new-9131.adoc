...
A partir de ONTAP 9.12.1, System Manager está integrado con la consola de NetApp . Obtenga más información sobre xref:../sysmgr-integration-console-concept.html[Integración de System Manager con la consola de NetApp] .
