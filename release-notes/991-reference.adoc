...
| link:../nfs-admin/ldaps-concept.html["Soporte LDAP en cualquier puerto"] | LDAPS se puede configurar en cualquier puerto, aunque el puerto 636 sigue siendo el predeterminado. 
