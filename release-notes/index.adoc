...
+
Amplía la protección autónoma contra el ransomware (ARP/AI) a SnapMirror synchronous para entornos SAN y NAS y a SnapMirror active sync en entornos SAN, conservando las señales de detección y recuperación en arquitecturas con RPO cero. 
