...
| Visualización en System Manager | X | X | X | X | X | X 


| Análisis de capacidad | X | X | X | X | X | X 


| Información de datos inactivos | X | X | X | X | X | X 


| Compatibilidad con volúmenes que han realizado la transición desde Data ONTAP 7-Mode | X | X | X | X | X |  


| Capacidad para personalizar el período inactivo en System Manager | X | X | X | X | X |  


| Seguimiento de actividad a nivel de volumen | X | X | X | X |  |  


| Descargue los datos de seguimiento de actividad en CSV | X | X | X | X |  |  


| Seguimiento de actividad a nivel de SVM | X | X | X |  |  |  


| Línea de tiempo | X | X | X |  |  |  


| Análisis del uso | X | X |  |  |  |  


| Opción para activar el análisis del sistema de archivos de forma predeterminada | X |  |  |  |  |  
|===
