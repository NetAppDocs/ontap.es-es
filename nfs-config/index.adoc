...
| System Manager Classic (disponible con ONTAP 9.7 y versiones anteriores) | link:https://docs.netapp.com/us-en/ontap-sm-classic/nfs-config/index.html["Información general de la configuración de NFS"^] 
|===