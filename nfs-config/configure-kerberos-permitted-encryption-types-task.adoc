...
summary: 'De forma predeterminada, ONTAP admite los siguientes tipos de cifrado para NFS Kerberos: DES, 3DES, AES-128 y AES-256. Puedes configurar los tipos de cifrado permitidos para cada SVM para adaptarlos a los requisitos de seguridad de tu entorno concreto usando el comando vserver nfs modify con el parámetro -permitted-enc-types.' 
---
