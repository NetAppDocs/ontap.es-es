...
summary: Como alternativa a la creación manual de usuarios UNIX locales individuales en SVM, puedes simplificar la tarea cargando una lista de usuarios UNIX locales en SVM a partir de un identificador uniforme de recursos. 
---
