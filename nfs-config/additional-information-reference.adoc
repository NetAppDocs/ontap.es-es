...
summary: Después de haber probado con éxito el acceso de cliente de NFS, puedes realizar configuración adicional de NFS o añadir acceso SAN. Cuando el acceso al protocolo esté completo, deberías proteger el volumen raíz de la storage virtual machine. 
---
...
* https://www.netapp.com/pdf.html?item=/media/16398-tr-3580.pdf["Informe técnico de NetApp 3580: Guía de mejoras y prácticas recomendadas de NFSv4: Implementación de Data ONTAP"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16885-tr-4182.pdf["Informe técnico de NetApp 4182: Consideraciones de diseño y prácticas recomendadas de almacenamiento Ethernet para las configuraciones de Data ONTAP en clúster"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16328-tr-4668.pdf["Informe técnico de NetApp 4668: Guía de prácticas recomendadas de servicios de nombres"^]
+
