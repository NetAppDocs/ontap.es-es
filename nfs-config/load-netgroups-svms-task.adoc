...
summary: Uno de los métodos que puedes usar para emparejar clientes en las reglas de la política de exportación es usando hosts listados en netgroups. Puedes cargar netgroups desde un identificador uniforme de recursos en SVMs como alternativa a usar netgroups almacenados en servidores de nombres externos. 
---
