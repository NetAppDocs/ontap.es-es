...
+
link:worksheet-reference.html#configuring-nfs-access-to-an-svm["Configuración del acceso NFS a una SVM"]

+
link:worksheet-reference.html#adding-storage-capacity-to-an-nfs-enabled-svm["Adición de capacidad de almacenamiento a una SVM habilitada para NFS"]

* Si va a añadir capacidad de almacenamiento a una SVM con NFS habilitado, solo debe completar la segunda sección.
+
link:worksheet-reference.html#adding-storage-capacity-to-an-nfs-enabled-svm["Adición de capacidad de almacenamiento a una SVM habilitada para NFS"]
