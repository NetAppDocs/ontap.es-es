...
summary: Si en tu entorno se utiliza un servicio de información de red para los servicios de nombres, debes crear una configuración de dominio NIS para la SVM mediante el comando vserver services name-service nis-domain create. 
---
