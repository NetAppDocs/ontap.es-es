...
summary: Puedes usar las políticas de exportación para restringir el acceso NFS a volúmenes o qtrees a clientes que coincidan con parámetros específicos. Al aprovisionar nuevo almacenamiento, puedes usar una política y reglas existentes, añadir reglas a una política existente o crear una nueva política y reglas. También puedes comprobar la configuración de las políticas de exportación. 
---
