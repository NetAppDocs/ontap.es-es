...
. Haga clic image:icon_kabob.gif["Opciones de menú"] junto al volumen de origen que desea restaurar para mostrar el menú y seleccione *Restaurar*.
...
. Haga clic en image:icon_kabob.gif["Opciones de menú"] Junto al volumen de origen y seleccione *Eliminar*.
...
.Pasos
. Haga clic en *Protección > Descripción general > Tiendas de objetos en la nube*.
. Seleccione el almacén de objetos que desea eliminar; haga clic en image:icon_kabob.gif["Opciones de menú"] Y seleccione *Eliminar*.
