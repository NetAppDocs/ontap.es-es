...
NOTE: Las mediciones de la capacidad utilizada se muestran de forma diferente en función de la versión de System Manager que esté usando, como se explica en link:../concepts/capacity_measurements_in_sm_concept.html["Mediciones de capacidad en System Manager"].
