...
TIP: Si usas MAV con Autonomous Ransomware Protection, define un grupo de aprobación nuevo o existente que sea responsable de aprobar las solicitudes para pausar, desactivar y borrar sospechas de protección contra ransomware.
