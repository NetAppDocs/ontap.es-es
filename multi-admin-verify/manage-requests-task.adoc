...
NOTE: `multi-admin-verify`Las solicitudes en un estado terminal pueden sobrescribirse o eliminarse automáticamente.  Utilice ellink:../system-admin/audit-display-log-contents-task.html["registro de auditoría"] para revisar solicitudes anteriores.
