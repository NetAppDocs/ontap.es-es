...
+
.. Haga clic en *clúster > Configuración.*
.. Haga clic en image:icon_arrow.gif["icono de flecha azul"] Junto a *aprobación Multi-Admin* en la sección *Seguridad*. (Verá la image:icon_gear.gif["icono de marcha"] Icono si MAV aún no está configurado.)
+
