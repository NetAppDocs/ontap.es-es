...
|===
Obtenga más información sobre `security multi-admin-verify rule` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=security+multi-admin-verify+rule["Referencia de comandos del ONTAP"^].
