...
|===
Puede crear reglas para proteger el siguiente comando a partir de ONTAP 9.13.1:
...
Las reglas para los comandos MAV system-default, el `security multi-admin-verify` link:../multi-admin-verify/index.html#how-multi-admin-verification-works["comandos"], no se puede modificar.
