...
. Compruebe que el acceso de usuario y grupo es correcto en las VM de almacenamiento de origen y de destino: Seleccione *Almacenamiento > VM de almacenamiento*, luego seleccione la VM de almacenamiento y luego *Configuración*. Por último, seleccione image:icon_pencil.gif["Icono Editar"] en *S3*.
+
