...
summary: Puedes empezar a proteger los buckets de S3 existentes en cualquier momento, por ejemplo, si actualizaste una configuración de S3 desde una versión anterior a ONTAP 9.10.1. 
---
