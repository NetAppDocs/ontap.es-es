...
A partir de ONTAP 9.15.1, SnapMirror active sync admite la reconfiguración automática en el tramo de distribución después de un evento de conmutación al respaldo. Si la conmutación al respaldo del sitio primario al secundario ha tenido éxito, el sitio terciario se reconfigura automáticamente para tratar al sitio secundario como origen. El tramo de distribución asíncrona puede ser una relación de grupo de consistencia en una configuración SAN o una relación de volumen independiente. La reconfiguración funcionará en cualquiera de los casos. La reconfiguración se activa por una conmutación al respaldo planificada o no planificada. La reconfiguración también ocurre cuando se revierte al sitio primario.
