...
A partir de ONTAP 9.11.1, AIX es compatible con la sincronización activa de SnapMirror a través de una solicitud de variación de política de funciones de ingeniería estándar (FPVR) con el acuerdo de que se entienden las siguientes estipulaciones:
