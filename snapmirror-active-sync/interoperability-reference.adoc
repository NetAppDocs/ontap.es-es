...
A partir de ONTAP 9.19.1 RC, ARP/AI admite volúmenes primarios que participan en relaciones SAN de sincronización activa SnapMirror. Para obtener más información, consulta link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["Casos de uso y consideraciones sobre la protección de Ransomware autónoma"].
