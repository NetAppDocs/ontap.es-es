...
NOTE: Asymmetric active/active no es compatible con ASA r2 y NVMe. Para obtener más información sobre la compatibilidad con NVMe, consulta link:../nvme/support-limitations.html["Configuración, compatibilidad y limitaciones de NVMe"].
