...
En las configuraciones asimétricas activas/pasivas, los datos del sitio secundario se proxyan a un LUN, namespace o unidad de almacenamiento.
...
Primary-first y el sesgo primario son compatibles en SnapMirror active sync a partir de ONTAP 9.15.1. Las copias primarias se designan en System Manager y se muestran mediante la API de REST de ONTAP y la CLI de ONTAP.
...
* NVMe para cargas de trabajo de VMware
 ...
 a| 
* Activo/pasivo asimétrico



NOTE: Asymmetric active/passive no es compatible con ASA r2 y NVMe. Para más información sobre la compatibilidad con NVMe, mira link:../nvme/support-limitations.html["Configuración, compatibilidad y limitaciones de NVMe"].
...
* FC
 ...
 a| 
* Activo/pasivo asimétrico
* Activo/activo simétrico Las configuraciones activo/activo simétrico admiten clústeres de 4 nodos a 4 nodos en ONTAP 9.16.1 y versiones posteriores. Para ASA r2, solo se admiten clústeres de 2 nodos.
...
* FC
 ...
 a| 
* Activo/pasivo asimétrico
* Activo/activo simétrico Las configuraciones activo/activo simétricas admiten clústeres de 2 nodos en ONTAP 9.15.1. Los clústeres de 2 nodos a 2 nodos y los clústeres de 4 nodos a 4 nodos se admiten en ONTAP 9.16.1 y versiones posteriores.
