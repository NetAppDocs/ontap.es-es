...
. Anule la asignación de todos los LUN que pertenecen al grupo de consistencia del Sitio B. Esto fallará, por lo que primero debe modificar el igroup para eliminar el par de replicación SVM y luego eliminar el mapa de LUN.
