...
== Eliminar una configuración SAN asimétrica

* Antes de eliminar la relación SAN de sincronización activa de SnapMirror, debes desasignar todas las LUN en el clúster de destino.
...
. En la ventana *Eliminar configuración de replicación*, marca *Liberar las instantáneas base del volumen de origen* y selecciona *Eliminar*.
...
== Eliminar una configuración de NAS
...
. En el clúster de origen, navegue a *Protección > Replicación*.
. Localice la relación que desea eliminar, seleccione image:icon_kabob.gif["Icono de opciones de menú"] y seleccione *Eliminar*.
. En la ventana *Eliminar configuración de replicación*, marca *Liberar las instantáneas base de la máquina virtual de almacenamiento de origen* y selecciona *Eliminar*.
...
----
+
La máquina virtual (SVM) y sus volúmenes se eliminan del clúster secundario.
