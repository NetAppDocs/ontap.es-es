...
-----END CERTIFICATE-----
----
. Agrega el certificado CA de ONTAP Mediator a un clúster ONTAP. Cuando se te solicite, inserta el certificado CA obtenido de ONTAP Mediator. Repite los pasos en todos los clústeres pares:
+
