...
----
. Consulte los pasos descritos en link:../mediator/manage-task.html#Replace-self-signed-certificates-with-trusted-third-party-certificates["Sustituya los certificados autofirmados por certificados de terceros de confianza"] Sobre cómo obtener certificados de CA subordinada, referida como `ca.crt`.
+
