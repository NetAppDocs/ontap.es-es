...
---
= Supervisar las operaciones de sincronización activa de ONTAP SnapMirror
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Puedes supervisar el estado y el progreso de una operación de conmutación por error planificada usando el comando  `snapmirror failover show`. Por ejemplo, en una configuración SAN:
