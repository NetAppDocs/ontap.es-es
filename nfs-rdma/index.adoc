...
* Los clientes Mellanox deben utilizar tarjetas NIC compatibles con RDMA y el software de red Mellanox OFED (MOFED). Para obtener más información sobre el soporte del adaptador, consulte la link:https://hwu.netapp.com/["Hardware Universe de NetApp"^]. Los adaptadores NFS a través de RDMA admitidos muestran «RoCE» en el campo de descripción.
