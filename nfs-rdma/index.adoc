...
[role="lead"]
NFS a través de RDMA utiliza adaptadores de red compatibles con RDMA, lo que permite copiar datos directamente entre la memoria del sistema de almacenamiento y la memoria del sistema host, evitando así las interrupciones y los gastos generales de la CPU.
