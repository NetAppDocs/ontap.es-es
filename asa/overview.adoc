...
Xref:../software_setup/concept_decide_whether_to_use_ontap_cli.html[Comience a configurar el clúster de ONTAP.
...
+
El *PERSONALITY* se muestra como *matriz All SAN*.

* *Desde la CLI*: Ingrese el `san config show` comando.
+
El valor de la "cabina All SAN" vuelve igual de cierto en los sistemas ASA.
