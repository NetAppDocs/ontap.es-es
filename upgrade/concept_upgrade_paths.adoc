...
*Atención las configuraciones de MetroCluster que se actualizan desde ONTAP 9,8*:
...
Las configuraciones de IP de MetroCluster en estas plataformas no se pueden actualizar de 9,8 directamente a 9.10.1 o una versión posterior.  Las rutas de actualización directa enumeradas se pueden utilizar para el resto de plataformas.
| 9.13.1 | salto múltiple directo (requiere imágenes para 9.12.1 y 9.13.1) 
