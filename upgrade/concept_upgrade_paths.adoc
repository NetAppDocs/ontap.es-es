...
.2+| 9.12.1 | 9.14.1 | directo 


| 9.13.1 | directo 


.3+| 9.11.1 | 9.14.1 | directo 
...
Las rutas de actualización para las actualizaciones de ONTAP 9,4, 9,3, 9,2, 9,1 y 9,0 pueden variar en función de si se realiza una actualización automatizada o manual.
