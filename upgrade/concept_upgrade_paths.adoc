...
+
Por ejemplo, puede utilizar la ruta de actualización directa de 9.12.1 a 9.13.1, o de 9.13.1 a 9.17.1.
...
+
Por ejemplo, si actualmente está ejecutando la versión 9.8 y desea actualizar a la versión 9.16.1, debe completar una actualización en varias etapas: primero de la versión 9.8 a la 9.12.1 y luego de la 9.12.1 a la 9.16.1.  Las actualizaciones desde versiones anteriores podrían requerir tres o más etapas, con varias actualizaciones intermedias.
...
=== Desde ONTAP 9.8 y posteriores

Las actualizaciones automatizadas y manuales de ONTAP 9.8 y posteriores siguen las mismas rutas de actualización.

.Desde ONTAP 9.15.1 y posteriores
[%collapsible]
====
Las siguientes rutas de actualización son compatibles con ONTAP 9.15.1 y posteriores para actualizaciones automatizadas y manuales.
...
| 9.18.1 | 9.19.1 | directo 


.2+| 9.17.1 | 9.19.1 | directo 


| 9.18.1 | directo 


.3+| 9.16.1 | 9.19.1 | directo 
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.14.1 para actualizaciones automatizadas y manuales.

[cols="25,25,50"]
|===
| Si tu versión actual de ONTAP es... | Y su versión ONTAP de destino es… | Su ruta de actualización automática o manual es… 
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.13.1 para actualizaciones automatizadas y manuales.
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.12.1 para actualizaciones automatizadas y manuales.
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.11.1 para actualizaciones automatizadas y manuales.
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.10.1 para actualizaciones automatizadas y manuales.
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles desde ONTAP 9.9.1 para actualizaciones automatizadas y manuales.
...
[%collapsible]
====
Las siguientes rutas de actualización son compatibles con ONTAP 9.8 para actualizaciones automatizadas y manuales.
...
=== Desde ONTAP 9.7 y 9.6

Para ONTAP 9.7 y 9.6, las rutas de actualización automática y manual pueden variar en función de la versión de ONTAP de destino.

.Desde ONTAP 9,7
[%collapsible]
====
La ruta de actualización manual de ONTAP 9.7 a 9.10.1 y 9.11.1 varía con respecto a la ruta de actualización automatizada. Estas variaciones se indican en la tabla siguiente. Para las actualizaciones de ONTAP 9.7 a todas las demás versiones de ONTAP, las actualizaciones automatizadas y manuales siguen la misma ruta de actualización.
...
| 9.11.1  a| 
* Ruta de actualización automatizada
+
salto múltiple directo (requiere imágenes para 9,8 y 9.11.1)

* Ruta de actualización manual
+
multietapa
...
[%collapsible]
====
La ruta de actualización manual de ONTAP 9.6 a 9.10.1 varía de la ruta de actualización automatizada. La variación se indica en la tabla siguiente. Para las actualizaciones de ONTAP 9.6 a todas las demás versiones de ONTAP, las actualizaciones automatizadas y manuales siguen la misma ruta de actualización.
...
Las rutas de actualización desde ONTAP 9.5 varían en función de si estás realizando una actualización automatizada o manual.

.Rutas de actualización automatizadas
[%collapsible]
====
Utiliza las siguientes rutas de actualización para las actualizaciones automatizadas desde ONTAP 9.5.

[cols="25,25,50"]
|===
| Si tu versión actual de ONTAP es... | Y su versión ONTAP de destino es… | Su ruta de actualización automatizada es… 
...
[%collapsible]
====
Utiliza las siguientes rutas de actualización para actualizaciones manuales desde ONTAP 9.5

[cols="25,25,50"]
|===
| Si tu versión actual de ONTAP es... | Y su versión ONTAP de destino es… | La ruta de actualización manual es… 
...
Las rutas de actualización desde ONTAP 9.4, 9.3, 9.2, 9.1 y 9.0 varían en función de si estás realizando una actualización automatizada o una actualización manual.

.Rutas de actualización automatizadas
[%collapsible]
====
Usa las siguientes rutas de actualización para las actualizaciones automatizadas desde ONTAP 9.4, 9.3, 9.2, 9.1 y 9.0.
...
[%collapsible]
====
Usa las siguientes rutas de actualización para actualizaciones manuales desde ONTAP 9.4, 9.3, 9.2, 9.1 y 9.0.
