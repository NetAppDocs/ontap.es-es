...
NOTE: Si está actualizando a ONTAP 9.15.1 o posterior a través de NetApp, siga laslink:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["procedimiento de actualización en la documentación de la consola de NetApp"^] .
...
+
<<<<<<< HEAD Para FTP anónimo, debes especificar la URL en el formato +ftp://anonymous@ftpserver+.



[]
=====
Para FTP anónimo, debes especificar la URL en el formato \ftp://anonymous@ftpserver. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
