...
* Si realiza una actualización automatizada no disruptiva con un link:concept_upgrade_paths.html#types-of-upgrade-paths["ruta de actualización directa de varios saltos"], Necesita descargar el paquete de software tanto para la versión intermedia de ONTAP como para la versión de destino de ONTAP necesaria para la actualización.  Por ejemplo, si va a actualizar de ONTAP 9,8 a ONTAP 9.13.1, debe descargar los paquetes de software tanto para ONTAP 9.12.1 como para ONTAP 9.13.1.  Consulte link:concept_upgrade_paths.html#supported-upgrade-paths-for-on-premises-ontap-and-ontap-select["rutas de actualización admitidas"] para determinar si la ruta de actualización requiere la descarga de un paquete de software intermedio.
