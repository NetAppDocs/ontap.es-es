...
| ¿Estoy usando SnapMirror de S3? ¿Estoy actualizando a ONTAP 9.12.1 o una versión posterior? | link:considerations-for-s3-snapmirror-concept.html["Consideraciones sobre las configuraciones de SnapMirror S3"] 
