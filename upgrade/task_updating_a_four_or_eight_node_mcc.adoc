...
---
= NDU manual de ONTAP en una configuración de cuatro u ocho nodos de MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Una actualización manual sin interrupción del servicio (NDU) de una configuración de MetroCluster de cuatro u ocho nodos implica preparar la actualización, actualizar simultáneamente los pares de DR en cada uno de los uno o dos grupos de DR y llevar a cabo las tareas posteriores a la actualización.

.Acerca de esta tarea
* Debes utilizar la interfaz de línea de comandos (CLI) de ONTAP para realizar esta tarea.
...
----
. Si el software MetroCluster Tiebreaker está activado, desactívalo.
...
----
+
El siguiente ejemplo muestra que la imagen de sistema2 (imagen ONTAP de destino) es la versión predeterminada y actual en node_A_1:
...
----
+
El siguiente ejemplo muestra que la imagen de sistema2 (imagen ONTAP de destino) es la versión por defecto y actual en node_B_1:
...
----
+
El siguiente ejemplo muestra que la imagen de sistema2 (imagen ONTAP de destino) es la versión por defecto y actual en node_A_2:
...
----
+
El siguiente ejemplo muestra que la imagen de sistema2 (imagen ONTAP de destino) es la versión por defecto y actual en node_B_2:
