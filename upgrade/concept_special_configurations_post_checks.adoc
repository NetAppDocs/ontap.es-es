...
| ¿He actualizado desde ONTAP 9,7 o anterior a ONTAP 9,8 o posterior? | xref:task_verifying_your_network_configuration_after_upgrade.html[Compruebe la configuración de red]
