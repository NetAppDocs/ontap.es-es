...
+
Obtenga más información sobre `cluster show` y `cluster ring show` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=cluster+show["Referencia de comandos de la ONTAP"^].
