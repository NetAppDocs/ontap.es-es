...
NOTE: Si va a actualizar ONTAP en una configuración de MetroCluster FC, también tiene que verificar que el clúster esté habilitado para la conmutación de sitios no planificada automática.
...
----
+
Si está realizando una link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html#types-of-upgrade-paths["actualización directa de varios saltos"], También necesita descargar el paquete de software para la versión intermedia de ONTAP necesaria para su actualización. Por ejemplo, si está actualizando de 9,8 a 9.13.1, debe descargar el paquete de software para ONTAP 9.12.1 y, a continuación, utilizar el mismo comando para descargar el paquete de software de 9.13.1.
