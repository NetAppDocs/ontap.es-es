...
---
= Actualiza manualmente un clúster ONTAP estándar de forma disruptiva
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Debes utilizar la interfaz de línea de comandos (CLI) de ONTAP para realizar una actualización manual con interrupción.
