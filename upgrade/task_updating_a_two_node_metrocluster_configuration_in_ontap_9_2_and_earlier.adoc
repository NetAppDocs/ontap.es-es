...
---
= Actualiza una configuración de ONTAP de dos nodos MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si tienes una configuración de dos nodos MetroCluster ejecutando ONTAP 9.3 o una versión posterior, usa los pasos de la CLI en link:automated-upgrade-task.html["Instale la imagen de ONTAP con actualizaciones de ONTAP automatizadas y no disruptivas"].
