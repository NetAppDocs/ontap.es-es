...
summary: A partir de ONTAP 9.8, puede usar secure-purge para limpiar datos sin interrupciones en volúmenes habilitados para NVE con una relación sincrónica de SnapMirror . 
---
