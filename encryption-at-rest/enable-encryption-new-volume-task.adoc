...
|===
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/volume-create.html[`volume create`^] en la referencia de comandos de ONTAP.
