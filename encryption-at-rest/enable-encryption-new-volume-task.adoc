...
|===
+
Para obtener la sintaxis completa del comando, consulte la página de referencia de comandos de LINK:https://docs.netapp.com/us-en/ontap-cli/volume-create.html[`volume create`#].
