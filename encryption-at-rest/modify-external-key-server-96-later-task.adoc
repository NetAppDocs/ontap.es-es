...
[role="lead"]
A partir de ONTAP 9.6, puede utilizar la `security key-manager external modify-server` Comando para cambiar el tiempo de espera de I/o y el nombre de usuario de un servidor de gestión de claves externo.
