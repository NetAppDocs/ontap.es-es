...
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/volume-encryption-conversion-start.html[`volume encryption conversion start`^] en la referencia de comandos de ONTAP.
...
+
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli//volume-show.html#parameters[`volume show -is-encrypted true`] en la referencia de comandos de ONTAP.
