...
Los sistemas AFF A220, AFF A800, FAS2720, FAS2750 y posteriores almacenan volcados principales en su dispositivo de arranque. Cuando se habilitan las unidades de autocifrado en estos sistemas, el volcado de memoria también se cifra.
