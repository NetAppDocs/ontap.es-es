...
Obtenga más información sobre `security key-manager onboard show-backup` en el link:https://docs.netapp.com/us-en/ontap-cli/security-key-manager-onboard-show-backup.html["Referencia de comandos de la ONTAP"^].
