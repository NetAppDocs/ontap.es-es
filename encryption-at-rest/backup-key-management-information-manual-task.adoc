...
Obtenga más información sobre `security key-manager onboard show-backup` en el link:https://docs.netapp.com/us-en/ontap-cli/security-key-manager-onboard-show-backup.html["Referencia de comandos del ONTAP"^].

+ El siguiente comando 9,6 muestra la información de copia de seguridad de gestión de claves `cluster1` para :
