...
Para obtener más información, consulte `security key-manager external` en la link:https://docs.netapp.com/us-en/ontap-cli-9141/["Referencia de comandos de la ONTAP"^].
