...
+
Obtenga más información sobre `storage aggregate show` en el link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-show.html?q=storage+aggregate+show["Referencia de comandos de la ONTAP"^].
