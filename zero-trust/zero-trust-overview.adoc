...
NOTE: A partir de julio de 2024, el contenido del informe técnico _TR-4015: NetApp y Confianza Cero: Habilitar un modelo de Confianza Cero_ centrado en los datos, que se publicó anteriormente como PDF, se ha integrado con el resto de la documentación de producto de ONTAP.
