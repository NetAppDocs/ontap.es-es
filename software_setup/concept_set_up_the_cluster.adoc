...
summary: La configuración del clúster implica recopilar la información necesaria para configurar cada nodo, crear el clúster en el primer nodo y unir los nodos restantes al clúster. 
---
= Recopile información del clúster para la configuración del clúster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
