...
[role="lead"]
Antes de configurar el cluster peering, debes confirmar que se cumplen los requisitos de conectividad, puerto, dirección IP, subred, firewall y cluster.
...
== Límites de clúster peer

El número de clústeres pares soportados depende de la versión de ONTAP:

* ONTAP 9.14.1 y posteriores: se admiten hasta 400 pares de clúster.
* Versiones anteriores de ONTAP: se admiten hasta 255 pares de clúster.
+
....
[NOTE]
