...
Para completar esta tarea mediante System Manager Classic (disponible con 9.7 y versiones anteriores), consulte https://["Configuración iSCSI para Red Hat Enterprise Linux"^]
...
https://["Consulte y gestione los iGroups SAN en System Manager"]
