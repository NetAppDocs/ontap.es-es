...
summary: 'ONTAP proporciona tres opciones básicas de aprovisionamiento de volúmenes: thick provisioning, thin provisioning y semi-thick provisioning. Cada opción utiliza diferentes formas de gestionar el espacio de volumen y los requisitos de espacio para las tecnologías de compartición de bloques de ONTAP. Entender cómo funcionan las opciones te permite elegir la mejor opción para tu entorno.' 
---
