...
summary: Si es necesario desconectar un nodo, puedes mover un SAN LIF para conservar su información de configuración, como su WWPN, y evitar la rezonificación de la estructura de conmutación. Como un SAN LIF debe desconectarse antes de moverlo, el tráfico del host debe depender del software de multivía del host para proporcionar acceso sin interrupciones al LUN. Puedes mover los SAN LIF a cualquier nodo de un clúster, pero no puedes mover los SAN LIF entre máquinas virtuales de almacenamiento. 
---
= Mover un LIF SAN
:allow-uri-read: 
:icons: font
