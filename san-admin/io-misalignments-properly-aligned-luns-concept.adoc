...
summary: ONTAP puede informar de desalineaciones de entrada y salida en LUNs correctamente alineados. En general, estas advertencias de desalineación pueden ignorarse siempre y cuando tú estés seguro de que tu LUN está correctamente aprovisionado y tu tabla de particionamiento es correcta. 
---
