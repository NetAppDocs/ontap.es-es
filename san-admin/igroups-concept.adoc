...
summary: Los grupos de iniciadores son tablas de WWPN de host de protocolo FC o nombres de nodo de host iSCSI. Puedes definir igroups y asignarlos a LUN para controlar qué iniciadores tienen acceso a los LUN. 
---
= Conoce los igroups de ONTAP SAN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
