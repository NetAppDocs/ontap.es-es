...
. Haga clic en *Activar FC*. + los puertos FC se asignan automáticamente.
...
. Haga clic en la ficha *Configuración* y, a continuación, haga clic en image:icon_gear.gif[""] Junto al protocolo FC.
