...
summary: Selective LUN Map reduce el número de rutas desde el host hasta el LUN. Con SLM, cuando se crea un nuevo mapa LUN, el LUN solo es accesible a través de rutas en el nodo propietario del LUN y su socio de HA. 
---
