...
summary: Las cabinas SAN all-flash NetApp están disponibles a partir de ONTAP 9.7. Las ASA son soluciones SAN all-flash basadas en plataformas AFF NetApp de eficacia probada. 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Informe técnico de NetApp 4080: Prácticas recomendadas para SAN moderno"^]
