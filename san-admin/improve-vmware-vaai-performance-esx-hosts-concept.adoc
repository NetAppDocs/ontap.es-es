...
summary: ONTAP es compatible con determinadas API de VMware vStorage para funciones de integración de matrices cuando el host ESX ejecuta ESX 4.1 o posterior. Estas funciones ayudan a descargar operaciones del host ESX al sistema de almacenamiento y aumentan el rendimiento de la red. El host ESX habilita las funciones automáticamente en el entorno correcto. 
---
