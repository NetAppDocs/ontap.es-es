...
. Selecciona *Habilitar NVMe/FC* o *Habilitar NVMe/TCP*.
. Si habilitas NVMe/TCP y quieres que las rutas de red cambien automáticamente al socio de HA en caso de fallo de un nodo, haz lo siguiente:
+
