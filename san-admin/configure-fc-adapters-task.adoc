...
. Si tienes un sistema AFF, ASA o FAS, sigue estos pasos para crear una LIF: Si tienes un sistema ASA r2, sigue link:https://docs.netapp.com/us-en/asa-r2/administer/manage-client-vm-access.html#create-a-lif-network-interface["este procedimiento de System Manager"^] para crear una LIF.
+
...
.. Selecciona el puerto principal.
.. Seleccione *Guardar*.
+
