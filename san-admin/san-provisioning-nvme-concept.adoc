...
summary: A partir de ONTAP 9.4, NVMe FC es compatible con el entorno SAN. NVMe FC permite a los administradores de almacenamiento aprovisionar espacios de nombres y subsistemas y luego asignar los espacios de nombres a subsistemas, de forma similar a como se aprovisionan los LUN y se asignan a igroups para FC e iSCSI. 
---
...
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Informe técnico de NetApp 4684: Implementación y configuración de San modernas con NVMe/FC"^]
