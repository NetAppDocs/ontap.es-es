...
summary: Deberías cambiar los módulos ópticos en el adaptador objetivo unificado para que admitan el modo de personalidad que has seleccionado para el adaptador. 
---
