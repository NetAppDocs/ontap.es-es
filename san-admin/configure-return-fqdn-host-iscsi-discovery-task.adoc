...
summary: A partir de ONTAP 9, los LIF de iSCSI se pueden configurar para que devuelvan un nombre de dominio completo cuando un SO host envía una operación de descubrimiento iSCSI SendTargets. Devolver un FQDN es útil cuando hay un dispositivo de traducción de direcciones de red entre el SO host y el servicio de almacenamiento. 
---
