...
summary: Puedes usar el protocolo non-volatile memory express para proporcionar almacenamiento en un entorno SAN. El protocolo NVMe está optimizado para el rendimiento con almacenamiento de estado sólido. 
---
