...
summary: Puedes mover un LUN a través de volúmenes dentro de una máquina virtual de almacenamiento, pero no puedes mover un LUN entre SVMs. Los LUNs movidos a través de volúmenes dentro de una SVM se mueven inmediatamente y sin pérdida de conectividad. 
---
= Mover una LUN
:allow-uri-read: 
:icons: font
