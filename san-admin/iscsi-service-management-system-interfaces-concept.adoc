...
summary: Puedes gestionar la disponibilidad del servicio iSCSI en las interfaces lógicas iSCSI de la máquina virtual de almacenamiento mediante los comandos vserver iscsi interface enable o vserver iscsi interface disable. 
---
