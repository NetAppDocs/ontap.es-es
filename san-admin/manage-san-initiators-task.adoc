...
+
** Haga clic en image:icon_add_blue_bg.png[""] para añadir un igroup.
...
** Pase el ratón sobre el igroup y, a continuación, haga clic en image:icon_kabob.gif[""] junto al nombre de un igroup para editar o eliminar el igroup.
