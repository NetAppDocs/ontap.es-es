...
Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli//lun-resize.html#description[`lun resize`^] en la referencia de comandos de ONTAP.
