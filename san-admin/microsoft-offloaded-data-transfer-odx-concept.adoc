...
summary: Microsoft Offloaded Data Transfer, también conocida como copia de datos descargados, permite la transferencia directa de datos dentro de un dispositivo de almacenamiento o entre dispositivos de almacenamiento compatibles sin transferir los datos a través del host. 
---
