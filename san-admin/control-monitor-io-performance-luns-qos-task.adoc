...
summary: Puedes controlar el rendimiento de entrada y salida de los LUN asignando LUN a grupos de políticas QoS de almacenamiento. Puedes controlar el rendimiento de entrada y salida para asegurarte de que las cargas de trabajo alcancen objetivos de rendimiento específicos o para limitar una carga de trabajo que afecta negativamente a otras cargas de trabajo. 
---
