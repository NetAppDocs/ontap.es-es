...
summary: En los entornos SAN, los sistemas de almacenamiento son objetivos que tienen dispositivos de destino de almacenamiento. Para iSCSI y FC, los dispositivos de destino de almacenamiento se denominan LUN. Para Non-Volatile Memory Express sobre Fibre Channel, los dispositivos de destino de almacenamiento se denominan namespaces. 
---
