...
ARP/AI crea una instantánea cuando se detectan los primeros indicios de un ataque. Luego, se realiza un análisis para confirmar o descartar el posible ataque. A partir de ONTAP 9.17.1, ARP/AI también genera instantáneas cada 4 horas; la presencia de estas instantáneas no debe considerarse una anomalía. Si se confirma un ataque, la probabilidad de ataque se establece en  `Moderate` y se genera una notificación de ataque.
...
*ONTAP 9.17.1 y versiones posteriores:*
...
| Convención de nombres prefijados  a| 
*ONTAP 9.16.1:*
