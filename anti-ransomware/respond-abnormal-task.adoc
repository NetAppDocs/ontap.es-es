...
+
*** Para advertencias sobre tipos de archivo, selecciona *Actualizar y borrar tipos de archivo sospechosos*.
...
----
. Genere un informe de ataque y especifique dónde guardarlo:
+
[source, cli]
----
...
. A partir de la versión 9.18.1, puede determinar el estado de `clear-suspect` operación:
+
[source, cli]
----
