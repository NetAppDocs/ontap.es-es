...
summary: Mantén actualizada la protección ARP/AI frente a las últimas amenazas de ransomware actualizando automáticamente o manualmente los paquetes de seguridad ARP/AI de forma independiente al ciclo de lanzamientos de ONTAP. 
---
...
NOTE: ARP (ONTAP 9.10.1 a 9.15.1) no admite actualizaciones automáticas del modelo de seguridad. Las funcionalidades de detección de seguridad solo se actualizan con las actualizaciones de software de ONTAP. Si usas ONTAP 9.15.1 o una versión anterior, consulta link:index.html["Aprenda sobre la protección autónoma contra el ransomware."].
...
NOTE: Asegúrate de instalar únicamente una actualización de ARP/AI más reciente que tu versión actual para evitar cualquier retroceso involuntario de ARP/AI.
...
* link:learn-about-arpai.html["Aprende sobre ARP/IA"]
