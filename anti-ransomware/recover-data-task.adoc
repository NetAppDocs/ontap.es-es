...
--
Obtenga más información sobre `volume snapshot` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=volume+snapshot["Referencia de comandos de la ONTAP"^].
