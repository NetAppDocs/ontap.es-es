...
* *SnapMirror synchronous y active sync*: A partir de ONTAP 9.19.1 RC, las instantáneas ARP creadas para volúmenes que participan en relaciones de SnapMirror synchronous o SnapMirror active sync siguen estas reglas adicionales:
+
