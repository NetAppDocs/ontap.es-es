...
.Modo activo
Para ARP que se ejecuta con ONTAP 9.10,1 a 9.15.1, ARP cambia a _modo activo_ después de que se completa el intervalo de aprendizaje óptimo. Una vez que ARP ha cambiado al modo activo, ONTAP crea instantáneas ARP para proteger los datos si se detecta una amenaza.
