...
* Después de actualizar a ONTAP 9.19.1 RC y habilitar ARP en los volúmenes que forman parte de SnapMirror synchronous o SnapMirror active sync relationships, la relación podría experimentar un breve estado de fuera de sincronización. Esta condición es temporal y la relación se resincronizará automáticamente sin ninguna intervención.
