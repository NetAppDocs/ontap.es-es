...
A partir de ONTAP 9.13.1, el aprendizaje adaptativo se ha agregado a la analítica ARP, y el cambio del modo de aprendizaje al modo activo se realiza automáticamente. Para obtener más información, consulte link:index.html#learning-and-active-mode["Aprendizaje y modo activo"].
