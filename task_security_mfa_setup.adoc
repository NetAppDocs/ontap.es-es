...
Para habilitar la autenticación SAML con System Manager, realice los pasos siguientes. Si el clúster ejecuta ONTAP 9,7 o una versión anterior, los pasos que debe seguir son diferentes. Consulte la ayuda en línea de System Manager disponible en su sistema.
...
.Acerca de esta tarea
Al deshabilitar la autenticación de SAML no se elimina la configuración de SAML.
