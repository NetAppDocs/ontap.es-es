...
summary: Seguimiento de actividad para ver archivos, directorios, clientes y usuarios activos en un volumen específico para solucionar problemas de rendimiento en tiempo real. 
---
