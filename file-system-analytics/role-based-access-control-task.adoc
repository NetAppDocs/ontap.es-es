...
====
.Más información
* xref:../authentication/predefined-roles-cluster-administrators-concept.html[Roles predefinidos para administradores de clústeres]
* xref:../task_security_administrator_access.html[Control del acceso de administrador con System Manager]
