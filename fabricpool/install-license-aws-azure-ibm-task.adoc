...
summary: La licencia de FabricPool que puede haber utilizado en el pasado cambia y solo se conserva para configuraciones que no sean compatibles con BlueXP . A partir del 21 de agosto de 2021, se introdujeron las nuevas licencias de Cloud Tiering para configuraciones de almacenamiento por niveles compatibles con BlueXP con el servicio Cloud Tiering. 
---
...
[role="lead"]
La licencia de FabricPool que puede haber utilizado en el pasado cambia y solo se conserva para configuraciones que no sean compatibles con BlueXP . A partir del 21 de agosto de 2021, se incorporaron las licencias de BYOL de Cloud Tiering para las configuraciones de organización en niveles que son compatibles con BlueXP mediante el servicio Cloud Tiering. La licencia BYOL para Cloud Tiering ahora se conoce como licencia de organización en niveles de BlueXP .

link:https://docs.netapp.com/us-en/bluexp-tiering/task-licensing-cloud-tiering.html#new-cloud-tiering-byol-licensing-starting-august-21-2021["Obtenga más información sobre la licencia BYOL de Cloud Tiering de BlueXP "^].
...
link:https://docs.netapp.com/us-en/bluexp-tiering/concept-cloud-tiering.html#features["Más información acerca del servicio de organización en niveles del cloud"^].
