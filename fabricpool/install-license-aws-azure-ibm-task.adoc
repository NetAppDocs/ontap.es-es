...
No se requiere una licencia si usas NetApp StorageGRID u ONTAP S3 para el nivel de nube. Cloud Volumes ONTAP no requiere una licencia FabricPool, sin importar el proveedor que estés usando.
