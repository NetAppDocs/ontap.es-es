...
* Se requiere link:install-license-aws-azure-ibm-task.html["Licencia de FabricPool"] cuando se realiza el tiering a IBM Cloud Object Storage desde clústeres locales.
