...
* Se necesita link:install-license-aws-azure-ibm-task.html["Licencia de FabricPool"] cuando se realiza la organización en niveles hacia Azure Blob Storage desde clústeres ONTAP locales.
* No se requiere licencia si usas Azure Blob Storage desde Cloud Volumes ONTAP o Azure NetApp Files.
