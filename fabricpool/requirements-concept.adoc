...
* No es posible desvincular un nivel de cloud de un nivel local una vez asociado; sin embargo, puede utilizar link:https:create-mirror-task.html["Espejo de FabricPool"] para adjuntar un nivel local a un nivel de nube diferente.
...
== Consideraciones adicionales al usar los controles de consistencia StorageGRID
