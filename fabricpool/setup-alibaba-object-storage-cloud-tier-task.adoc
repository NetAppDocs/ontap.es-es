...
+
Los sistemas AFF recientemente solicitados incluyen 10 TB de capacidad libre para usar FabricPool. Si necesita capacidad adicional en un sistema AFF, si utiliza Alibaba Cloud Object Storage en un sistema distinto a AFF o si actualiza desde un clúster existente, necesita uno link:https://docs.netapp.com/us-en/ontap/fabricpool/install-license-aws-azure-ibm-task.html["Licencia de FabricPool"].
