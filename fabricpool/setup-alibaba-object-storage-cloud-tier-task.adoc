...
* Se necesita link:install-license-aws-azure-ibm-task.html["Licencia de FabricPool"] cuando se realiza la organización en niveles hacia Alibaba Cloud Object Storage desde clústeres ONTAP locales.
