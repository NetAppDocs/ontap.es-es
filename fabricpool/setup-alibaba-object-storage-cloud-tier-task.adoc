...
* Se requiere un link:https://console.netapp.com/cloud-tiering["Licencia de NetApp Cloud Tiering"^] cuando se realiza tiering a Alibaba Cloud Object Storage. Para obtener más información, consulta link:install-license-aws-azure-ibm-task.html["Instale una licencia de FabricPool en un clúster de ONTAP"].
