...
+
** Cuando tenga agregados de disco duro existentes, vaya a *almacenamiento > niveles* y haga clic en image:icon_kabob.gif["Opciones de menú"] para el agregado en el que desea habilitar la generación de informes de datos inactivos.
