...
+
Si necesita capacidad adicional en un sistema AFF, si usa Amazon S3 en un sistema que no sea de AFF o si actualiza desde un clúster existente, necesita una link:../fabricpool/install-license-aws-azure-ibm-task.html["Licencia de FabricPool"].
