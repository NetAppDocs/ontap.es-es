...
====
Puede utilizar el `volume object-store tiering show` Comando para ver el estado de organización en niveles de un volumen de FabricPool. Para obtener más información, consulte link:https://docs.netapp.com/us-en/ontap-cli/["Referencia de comandos"].
