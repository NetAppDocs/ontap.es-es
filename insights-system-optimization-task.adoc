...
Para obtener más información sobre las FPolicy nativas, consulte https://docs.netapp.com/us-en/ontap/nas-audit/fpolicy-config-types-concept.html["Tipos de configuración de FPolicy"].
