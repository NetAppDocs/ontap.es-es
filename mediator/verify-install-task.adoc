...
summary: Después de instalar ONTAP Mediator, debe verificar que esté ejecutándose. 
---
= Compruebe el estado de instalación de ONTAP Mediator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si instalaste ONTAP Mediator 1.12 o posterior con soporte solo para HTTPS, el paquete SCST no está instalado y puedes omitir este paso.
