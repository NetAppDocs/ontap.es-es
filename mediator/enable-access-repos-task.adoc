...
.Procedimiento para el sistema operativo Oracle Linux 10.x
[#OL10x%collapsible]
====
Usa este procedimiento si tu sistema operativo es *Oracle Linux 10.x* para habilitar el acceso a los repositorios:
...
====
.Procedimiento para el sistema operativo Oracle Linux 9.x
[#OL9x%collapsible]
====
Usa este procedimiento si tu sistema operativo es *Oracle Linux 9.x* para habilitar el acceso a los repositorios:
