...
====
.Procedimiento para sistemas operativos Rocky Linux 8, 9 o 10
[#rocky-linux-8-9-10%collapsible]
====
Utilice este procedimiento si su sistema operativo es *Rocky Linux 8*, *Rocky Linux 9* o *Rocky Linux 10* para habilitar el acceso a los repositorios:
