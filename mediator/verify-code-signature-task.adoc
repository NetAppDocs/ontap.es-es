...
`ontap-mediator-1.7.0`
 a| 
Ejecutable de instalación del producto para la versión 1.7.0
...
----
. Compruebe el `ontap-mediator-1.6.0.sig.tsr` y.. `ontap-mediator-1.7.0.tsr` archivos que utilizan los certificados asociados:
+
`openssl ts -verify`
