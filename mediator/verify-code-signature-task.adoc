...
`ontap-mediator-1.12.0`
 a| 
El ejecutable de instalación del producto para la versión 1.12
...
----
. Verifica los archivos `ontap-mediator-1.12.0.sig.tsr` y `ontap-mediator-1.12.0.tsr` usando los certificados asociados:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
