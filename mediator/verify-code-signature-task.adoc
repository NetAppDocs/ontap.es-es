...
[NOTE]
====
* A partir del 15 de junio de 2025, no puedes instalar ni actualizar a ONTAP Mediator 1.9 y 1.8 porque los certificados de verificación de firma de código han caducado. En su lugar, instala o actualiza a ONTAP Mediator 1.11 o 1.10.
...
----
. Verifica los archivos `ontap-mediator-1.11.0.sig.tsr` y `ontap-mediator-1.11.0.tsr` usando los certificados asociados:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
