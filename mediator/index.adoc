...
[CAUTION]
====
* Cuando ONTAP Mediator está configurado con el protocolo HTTPS en las configuraciones de IP de MetroCluster, una única instancia de ONTAP Mediator solo puede supervisar una configuración de IP de MetroCluster. No se admite la supervisión simultánea de varias configuraciones IP de MetroCluster.
