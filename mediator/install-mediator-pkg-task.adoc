...
+
Alternativamente, puedes usar la opción `--https-only` en el comando `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` para especificar solo HTTPS.
...
[NOTE]
====
Para omitir la comprobación de firmas durante la instalación, usa este comando: `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
