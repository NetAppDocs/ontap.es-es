...
NOTE: Para omitir la comprobación de firma durante la instalación, utilice este comando: `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
