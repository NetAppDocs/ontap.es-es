...
summary: Para instalar ONTAP Mediator, debes obtener el paquete de instalación y ejecutar el instalador en el host. 
---
...
[role="lead"]
Para instalar ONTAP Mediator, debes obtener el paquete de instalación y ejecutar el instalador en el host.
...
NOTE: Para omitir la comprobación de firmas durante la instalación, usa este comando: `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
...
.Ejemplo de instalación de ONTAP Mediator (salida de consola)
[%collapsible]
====
[listing]
----
