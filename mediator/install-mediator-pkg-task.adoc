...
NOTE: Para omitir la comprobación automática de firmas durante la instalación, utilice el siguiente comando: `./ontap-mediator-1.9.0/ontap-mediator-1.9.0 -y --skip-code-signature-check`
