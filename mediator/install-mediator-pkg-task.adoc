...
[CAUTION]
====
* En las configuraciones de IP de MetroCluster, cuando ONTAP Mediator está configurado con el protocolo HTTPS, una única instancia de ONTAP Mediator solo puede supervisar una configuración de IP de MetroCluster. No se admite la supervisión simultánea de varias configuraciones IP de MetroCluster.
