...
---
= Gestionar el servicio ONTAP Mediator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si utilizó `ca.crt` para firmar el `ontap_mediator_server.crt` certificado,  `ca.srl` se genera el archivo. Consulte <<step_2_intermediate_info,Paso 2: Genere un certificado de servidor firmando con una certificación de CA de terceros>> para obtener más información.
