...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Dos"]link:upgrade-host-os-mediator-task.html["Actualizar el SO del host y el Mediator"]
[role="quick-margin-para"]
Si estás actualizando una versión existente de ONTAP Mediator, primero debes desinstalar la versión anterior y luego instalar la nueva versión. Si estás instalando ONTAP Mediator por primera vez, puedes omitir este paso.
