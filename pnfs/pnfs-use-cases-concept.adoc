...
summary: Puedes usar pNFS con varias funciones de ONTAP, incluyendo nconnect, session trunking y balanceo de capacidad avanzado, para mejorar el rendimiento y la flexibilidad. 
---
