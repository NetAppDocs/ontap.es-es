...
summary: Utilice estos comandos CLI de ONTAP para configurar, solucionar problemas y recopilar estadísticas para pNFS. 
---
...
== Ver la lista de contadores específicos de pNFS (privilegios avanzados)
...
* link:pnfs-overview.html["Obtenga más información sobre NFS paralelo (pNFS) en ONTAP"]
