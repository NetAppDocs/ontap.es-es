...
** `*volumeAdd.yaml*` (o. `*volumeEdit.yaml*`): Los casos de prueba necesarios para crear o modificar los valores al leer las entradas de `variable.yaml` archivo.
...
** `*lunAdd.yaml*` (o. `*lunEdit.yaml*`): Los casos de prueba necesarios para crear o modificar los valores al leer las entradas de `variable.yaml` archivo.
...
| Añada una LUN | `lunAdd-variable.yaml` | `lunAdd.yaml` 
