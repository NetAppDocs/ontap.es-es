...
summary: La interfaz de línea de comandos de ONTAP proporciona una vista basada en comandos de la interfaz de gestión. Introduces comandos en el indicador del sistema de almacenamiento y los resultados de los comandos se muestran en texto. 
---
