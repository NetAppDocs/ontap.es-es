...
summary: Los ficheros de copia de seguridad de configuración son ficheros de archivo que contienen información para todas las opciones configurables que son necesarias para que el clúster, y los nodos que lo componen, funcionen correctamente. 
---
