...
El siguiente ejemplo muestra cómo el usuario llamado "joe", que tiene configurado acceso Telnet, puede emitir una solicitud Telnet para acceder a un clúster cuyo LIF de administración de clúster es 10.72.137.28:
