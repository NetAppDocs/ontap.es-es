...
summary: Configurar el acceso a los servicios web permite a los usuarios autorizados usar HTTP o HTTPS para acceder al contenido del servicio en el clúster o en una máquina virtual de almacenamiento. 
---
