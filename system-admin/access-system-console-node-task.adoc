...
summary: Si un nodo está colgado en el menú de arranque o en el prompt del entorno de arranque, solo puedes acceder a él a través de la consola del sistema. Puedes acceder a la consola del sistema de un nodo desde una conexión SSH al SP del nodo o al cluster. 
---
