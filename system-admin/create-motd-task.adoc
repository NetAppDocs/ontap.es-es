...
summary: Puedes crear un mensaje del día para comunicar información a usuarios CLI autenticados. El MOTD se muestra en una sesión de consola o una sesión SSH después de que un usuario es autenticado pero antes de que aparezca el prompt de clustershell. 
---
