...
summary: Puedes activar la configuración de red automática a nivel de clúster para el SP. También puedes dejar desactivada la configuración de red automática del SP y gestionar la configuración de red del SP manualmente a nivel de nodo. Existen algunas consideraciones para cada caso. 
---
