...
summary: Si existe quórum en todo el clúster, pero uno o más nodos no están sincronizados con el clúster, entonces debes sincronizar el nodo para restaurar la base de datos replicada en el nodo y hacer que entre en quórum. 
---
