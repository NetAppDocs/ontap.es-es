...
summary: Puedes activar o desactivar un servicio web para el clúster o una máquina virtual de almacenamiento, mostrar la configuración de los servicios web y controlar si los usuarios de un rol pueden acceder a un servicio web. 
---
