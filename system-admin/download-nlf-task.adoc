...
.Pasos
Puedes descargar archivos de licencia de ONTAP One para sistemas con paquetes de archivos de licencia existentes de NetApp y para sistemas con claves de licencia de 28 caracteres que se han convertido en archivos de licencia de NetApp en sistemas que ejecutan ONTAP 9.10.1 y versiones posteriores. Por una tarifa, también puedes actualizar sistemas de ONTAP Base a ONTAP One. Para más información sobre cómo descargar archivos de licencia de NetApp, consulta el artículo de la KB link:https://kb.netapp.com/nss/Licensing/How_to_download_NLF_licenses_from_the_NetApp_Support_Site["Cómo descargar licencias NLF desde el NetApp Support Site"^].
