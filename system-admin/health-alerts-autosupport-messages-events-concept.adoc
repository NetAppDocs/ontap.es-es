...
summary: Las alertas de estado del sistema activan los mensajes AutoSupport y los eventos en el Sistema de Gestión de Eventos, lo que te permite supervisar el estado del sistema usando los mensajes AutoSupport y el EMS, además de utilizar directamente el sistema de control del estado. 
---
