...
summary: En determinadas plataformas de hardware, el software se personaliza para admitir un nuevo controlador integrado llamado Baseboard Management Controller. El BMC tiene comandos de la línea de comandos que puedes usar para gestionar el dispositivo de forma remota. 
---
