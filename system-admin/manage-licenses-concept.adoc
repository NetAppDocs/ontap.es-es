...
summary: 'Una licencia es un registro de uno o más derechos de software. En ONTAP 8.2 a ONTAP 9.9.1, las licencias se ofrecen como cadenas de 28 caracteres y hay una clave por función ONTAP. En ONTAP 9,2 se introdujo un nuevo formato de licencia llamado Archivo de licencia de NetApp (NLF) solo para funciones para todo el clúster.' 
---
