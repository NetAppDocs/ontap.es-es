...
summary: Una licencia es un registro de uno o más derechos de software. A partir de ONTAP 9.10.1, todas las licencias se entregan como un archivo de licencia NetApp, que es un único archivo que habilita varias funciones. A partir de mayo de 2023, todos los sistemas AFF y FAS se venden con el paquete de software ONTAP One o con el paquete de software ONTAP Base y, a partir de junio de 2023, todos los sistemas ASA se venden con ONTAP One para SAN. 
---
...
ONTAP One incluye todas las funciones con licencia disponibles. Incluye una combinación de los contenidos de los antiguos paquetes Core, Data Protection, Security and Compliance, Hybrid Cloud y Encryption. El cifrado no está disponible en países restringidos.
...
A partir de junio de 2023, los sistemas ONTAP que utilicen claves de licencia de 28 caracteres también podrán link:https://kb.netapp.com/onprem/ontap/os/How_to_get_an_ONTAP_One_license_when_the_system_has_28_character_keys["Actualice al paquete de compatibilidad ONTAP One o ONTAP Base"^].
