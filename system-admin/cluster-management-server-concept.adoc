...
summary: El servidor de gestión de clústeres, también denominado adminSVM, es una implementación de máquina virtual de almacenamiento especializada que presenta el clúster como una única entidad gestionable. Además de servir como dominio administrativo de más alto nivel, el servidor de gestión de clústeres posee recursos que no pertenecen lógicamente a una SVM de datos. 
---
