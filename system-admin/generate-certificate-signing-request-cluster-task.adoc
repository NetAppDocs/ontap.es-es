...
summary: Puedes usar el comando security certificate generate-csr para generar una solicitud de firma de certificado. Después de procesar tu solicitud, la autoridad de certificación te envía el certificado digital firmado. 
---
