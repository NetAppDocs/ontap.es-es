...
+
 `-application`El parámetro de los[`security login` comandos especifica el método de acceso para una cuenta de usuario. Obtenga más información acerca del comando link:https://docs.NetApp.com/us-en/ONTAP-cli/security-login-create.html#description[`security login`] en la referencia de comandos de ONTAP.
