...
* A partir de ONTAP 9.19.1, los administradores pueden usar el link:https://docs.netapp.com/us-en/ontap-cli/security-ssh-publickey-show.html["Comando security ssh publickey show -vserver  -host-key-algorithm "^] para ver la huella digital de la clave del host de ONTAP. Esto permite a los administradores verificar que esta huella digital coincide con la que está almacenada en ONTAP.
