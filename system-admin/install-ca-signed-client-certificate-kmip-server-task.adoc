...
summary: El subtipo de certificado de Key Management Interoperability Protocol, junto con los tipos client y server-ca, especifica que el certificado se utiliza para autenticar mutuamente el clúster y un gestor de claves externo, como un servidor KMIP. 
---
