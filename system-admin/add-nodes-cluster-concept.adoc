...
[NOTE]
====
Para obtener más información sobre la configuración de un clúster mediante la GUI de configuración, consulta la link:../task_admin_add_nodes_to_cluster.html["documentación de gestión de nodos"]. Aprende más sobre `cluster setup` en la link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["Referencia de comandos del ONTAP"^].
