...
+
** link:https://docs.netapp.com/us-en/ontap-systems/aff-aseries/index.html["Sistemas AFF de la serie A"^]
** link:https://docs.netapp.com/us-en/ontap-systems/aff-cseries/index.html["Sistemas AFF C-series"^]
