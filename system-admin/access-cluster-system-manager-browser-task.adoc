...
summary: Si prefieres utilizar una interfaz gráfica en lugar de la interfaz de línea de comandos para acceder y gestionar un cluster, puedes hacerlo utilizando System Manager, que se incluye con ONTAP como servicio web, está habilitado por defecto y es accesible utilizando un navegador. 
---
