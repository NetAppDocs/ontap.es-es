...
* Puede cambiar el tamaño máximo del archivo si es necesario. Obtenga más información sobre `system node autosupport modify` en el link:https://docs.netapp.com/us-en/ontap-cli/system-node-autosupport-modify.html["Referencia de comandos de la ONTAP"^].
...
----
+
Obtenga más información sobre `security certificate show` en el link:https://docs.netapp.com/us-en/ontap-cli/security-certificate-show.html["Referencia de comandos de la ONTAP"^].
