...
summary: Puedes administrar los sistemas ONTAP con la interfaz de línea de comandos. 
---
...
Para obtener detalles sobre la sintaxis y el uso de la CLI, consulte link:../concepts/manual-pages.html["Referencia de comandos del ONTAP"] la documentación.
