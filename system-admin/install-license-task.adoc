...
summary: Puedes instalar archivos de licencia NetApp y claves de licencia usando System Manager, que es el método preferido para instalar NLFs, o puedes usar la CLI de ONTAP para instalar claves de licencia. En ONTAP 9.10.1 y versiones posteriores, las funciones se habilitan con un archivo de licencia NetApp, y en versiones anteriores a ONTAP 9.10.1, las funciones de ONTAP se habilitan con claves de licencia. 
---
