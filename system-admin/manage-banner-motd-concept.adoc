...
summary: ONTAP permite configurar un banner de inicio de sesión o un mensaje del día para comunicar información administrativa a los usuarios de System Manager y CLI del clúster o de la máquina virtual de almacenamiento. 
---
