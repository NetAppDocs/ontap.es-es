...
summary: ONTAP proporciona un conjunto predeterminado de certificados raíz de confianza para las aplicaciones ONTAP que utilizan Transport Layer Security. 
---
