...
Para obtener una lista de secuencias de escape que se pueden utilizar para generar contenido de forma dinámica para el MOTD, consulte la link:https://docs.netapp.com/us-en/ontap-cli//security-login-motd-modify.html#parameters["referencia de comandos"].
