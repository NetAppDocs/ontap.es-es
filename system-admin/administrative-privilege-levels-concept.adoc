...
summary: 'Los comandos y parámetros de ONTAP se definen en tres niveles de privilegio: admin, avanzado y diagnóstico. Los niveles de privilegio reflejan los niveles de habilidad necesarios para realizar las tareas.' 
---
