...
PRÁCTICA ÓPTIMA: NFSv4.1 o NFSv4.2 deben utilizarse en lugar de NFSv4.0. NFSv4.0 es una versión antigua del protocolo NFS y ya no es desarrollada activamente por la comunidad NFS.
