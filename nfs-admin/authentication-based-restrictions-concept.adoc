...
summary: Con las restricciones basadas en la autenticación, puedes especificar qué máquinas cliente y qué usuarios pueden conectarse a la máquina virtual de almacenamiento. 
---
