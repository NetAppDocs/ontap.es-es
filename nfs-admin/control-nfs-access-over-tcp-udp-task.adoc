...
summary: Puedes activar o desactivar el acceso NFS a las máquinas virtuales de almacenamiento a través de TCP y UDP modificando los parámetros -tcp y -udp, respectivamente. Esto te permite controlar si los clientes NFS pueden acceder a los datos a través de TCP o UDP en tu entorno. 
---
