...
sidebar: sidebar 
keywords: use, ldap 
summary: Un servidor LDAP te permite mantener de forma centralizada la información de los usuarios. Si almacenas tu base de datos de usuarios en un servidor LDAP de tu entorno, puedes configurar tu sistema de almacenamiento para que busque la información de los usuarios en tu base de datos LDAP existente. 
---
...
Para más información, consulta https://www.netapp.com/pdf.html?item=/media/19423-tr-4835.pdf["Informe técnico de NetApp 4835: Cómo configurar LDAP en ONTAP"^].
