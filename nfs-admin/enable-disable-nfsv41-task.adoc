...
summary: Puedes activar o desactivar NFSv4.1 modificando la opción -v4.1. Esto permite el acceso a archivos para clientes que usan el protocolo NFSv4.1. En ONTAP 9.9.1, NFSv4.1 está habilitado por defecto. En versiones anteriores, está deshabilitado por defecto. 
---
