...
summary: Los estilos de seguridad pueden establecerse en los volúmenes FlexVol y qtrees. Los estilos de seguridad pueden establecerse manualmente en el momento de la creación, heredarse automáticamente o modificarse posteriormente. 
---
