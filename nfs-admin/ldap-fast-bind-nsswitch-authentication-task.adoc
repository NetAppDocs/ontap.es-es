...
summary: A partir de ONTAP 9.11.1, puedes aprovechar la funcionalidad _fast bind_ de LDAP para solicitudes de autenticación de clientes más rápidas y sencillas. Para usar esta funcionalidad, el servidor LDAP debe soportar la funcionalidad fast bind. 
---
...
* El número UID y el número GID del administrador deben estar rellenados y ser consultables para que la vinculación rápida tenga éxito.
