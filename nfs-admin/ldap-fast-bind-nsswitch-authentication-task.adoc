...
** Para nuevos usuarios administradores, consulte link:../authentication/grant-access-nis-ldap-user-accounts-task.html["Habilite el acceso a cuenta de LDAP o NIS."]
