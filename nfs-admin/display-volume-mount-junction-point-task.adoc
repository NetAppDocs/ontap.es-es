...
summary: Puedes mostrar información sobre volúmenes montados para máquinas virtuales de almacenamiento y los puntos de unión en los que están montados los volúmenes. También puedes determinar qué volúmenes no están montados en un punto de unión. Puedes utilizar esta información para comprender y gestionar tu espacio de nombres SVM. 
---
