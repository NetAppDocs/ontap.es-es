...
summary: Puedes gestionar la caché del servicio de nombres modificando el valor del tiempo de vida. El valor TTL determina cuánto tiempo la información del servicio de nombres permanece en la caché. 
---
