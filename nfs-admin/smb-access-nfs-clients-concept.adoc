...
summary: ONTAP utiliza la semántica de seguridad del sistema de archivos de Windows NT para determinar si un usuario UNIX, en un cliente de NFS, tiene acceso a un archivo con permisos NTFS. 
---
