...
summary: Debes completar una serie de pasos para permitir que los clientes accedan a los archivos de las máquinas virtuales de almacenamiento mediante NFS. Hay algunos pasos adicionales que son opcionales dependiendo de la configuración actual de tu entorno. 
---
