...
summary: Puedes mostrar estadísticas NFS para máquinas virtuales de almacenamiento en el sistema de almacenamiento para supervisar el rendimiento y diagnosticar problemas. 
---
