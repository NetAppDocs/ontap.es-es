...
summary: El protocolo de cuota remota permite a los clientes de NFS obtener información sobre las cuotas de los usuarios de una máquina remota. La compatibilidad con las versiones de rquota varía en función de tu versión de ONTAP. 
---
