...
summary: Al activar las referencias NFSv4, ONTAP proporciona referencias intra-SVM a los clientes NFSv4. La referencia intra-SVM es cuando un nodo del clúster que recibe la solicitud NFSv4 remite al cliente NFSv4 a otra interfaz lógica en la máquina virtual de almacenamiento. 
---
