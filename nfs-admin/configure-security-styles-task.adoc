...
summary: Configuras el estilo de seguridad del volumen FlexVol para determinar el tipo de permisos utilizados para los datos en los volúmenes FlexVol de la máquina virtual de almacenamiento. 
---
