...
summary: Puedes activar o desactivar la compatibilidad con VMware vStorage sobre NFS en máquinas virtuales de almacenamiento usando el comando vserver nfs modify. 
---
