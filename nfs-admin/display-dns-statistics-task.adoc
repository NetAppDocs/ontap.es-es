...
summary: 'Puede mostrar estadísticas de DNS de las máquinas virtuales de almacenamiento (SVM) en el sistema de almacenamiento para supervisar el rendimiento y diagnosticar problemas.' 
---
...
[role="lead"]
Puede mostrar estadísticas de DNS de las máquinas virtuales de almacenamiento (SVM) en el sistema de almacenamiento para supervisar el rendimiento y diagnosticar problemas.

.Pasos
. Utilice la `statistics catalog object show` Comando para identificar los objetos DNS desde los que se pueden ver datos.
+
