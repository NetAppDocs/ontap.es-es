...
summary: Puedes mostrar las estadísticas DNS de las máquinas virtuales de almacenamiento en el sistema de almacenamiento para supervisar el rendimiento y diagnosticar problemas. 
---
