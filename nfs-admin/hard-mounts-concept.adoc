...
summary: 'Al solucionar problemas de montaje, tienes que asegurarte de que estás utilizando el tipo de montaje correcto. NFS admite dos tipos de montaje: montajes suaves y montajes duros. Deberías usar solo montajes duros por motivos de fiabilidad.' 
---
