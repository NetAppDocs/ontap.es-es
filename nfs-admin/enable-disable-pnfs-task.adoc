...
summary: pNFS mejora el rendimiento al permitir que los clientes de NFS realicen operaciones de lectura/escritura en dispositivos de almacenamiento directamente y en paralelo, evitando que el servidor NFS sea un posible cuello de botella. Para activar o desactivar pNFS, puedes modificar la opción -v4.1-pnfs. 
---
