...
summary: Puedes configurar ONTAP para permitir que los clientes NFS accedan a datos con estilo de seguridad NTFS y que los clientes NTFS accedan a datos con estilo de seguridad NFS. Cuando uses el estilo de seguridad NTFS en un almacén de datos NFS, debes decidir cómo tratar el acceso del usuario raíz y configurar la máquina virtual de almacenamiento en consecuencia. 
---
