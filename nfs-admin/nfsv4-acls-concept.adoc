...
summary: Un cliente que utiliza ACL NFSv4 puede establecer y ver ACL en archivos y directorios del sistema. Cuando se crea un nuevo archivo o subdirectorio en un directorio que tiene una ACL, el nuevo archivo o subdirectorio hereda todas las entradas de control de acceso de la ACL que se han etiquetado con los indicadores de herencia adecuados. 
---
