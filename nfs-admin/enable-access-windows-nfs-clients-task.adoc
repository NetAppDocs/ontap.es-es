...
summary: ONTAP admite el acceso a archivos desde clientes NFSv3 de Windows. Esto significa que los clientes que ejecutan sistemas operativos Windows compatibles con NFSv3 pueden acceder a archivos en exportaciones NFSv3 en el clúster. Para utilizar correctamente esta funcionalidad, debes configurar correctamente la máquina virtual de almacenamiento y conocer ciertos requisitos y limitaciones. 
---
