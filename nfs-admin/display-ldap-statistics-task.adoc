...
summary: Puedes mostrar estadísticas LDAP para máquinas virtuales de almacenamiento en un sistema de almacenamiento para supervisar el rendimiento y diagnosticar problemas. 
---
