...
summary: Por defecto, ONTAP realiza una verificación adicional al evaluar el acceso del cliente para un netgroup. La verificación adicional garantiza que el dominio del cliente coincide con la configuración del dominio de la máquina virtual de almacenamiento. De lo contrario, ONTAP deniega el acceso al cliente. 
---
