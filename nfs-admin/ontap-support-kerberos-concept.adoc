...
summary: Kerberos proporciona autenticación segura y sólida para aplicaciones cliente/servidor. La autenticación proporciona verificación de identidades de usuario y de proceso a un servidor. En el entorno ONTAP, Kerberos proporciona autenticación entre máquinas virtuales de almacenamiento y clientes NFS. 
---
