...
summary: Para especificar el periodo de arrendamiento de bloqueo NFSv4, puedes modificar la opción -v4-lease-seconds. Los periodos de arrendamiento más cortos aceleran la recuperación del servidor, mientras que los periodos de arrendamiento más largos son beneficiosos para los servidores que gestionan una gran cantidad de clientes. 
---
