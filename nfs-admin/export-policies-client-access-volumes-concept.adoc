...
summary: Las políticas de exportación contienen una o más reglas de exportación que procesan cada solicitud de acceso del cliente. El resultado del proceso determina si se deniega o se concede el acceso al cliente y qué nivel de acceso. Debe existir una política de exportación con reglas de exportación en la máquina virtual de almacenamiento para que los clientes puedan acceder a los datos. 
---
