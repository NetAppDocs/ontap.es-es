...
`-default-site`
 a| 
Opcional: a partir de ONTAP 9.13.1, el sitio predeterminado que se utiliza si un LIF no pertenece a ningún sitio y como alternativa en caso de que falle la detección de sitios en el dominio de confianza.
 a| 
