...
summary: La hoja de datos de configuración de SMB le permite recopilar la información necesaria para configurar el acceso SMB para los clientes. 
---
...
[role="lead"]
La hoja de datos de configuración de SMB le permite recopilar la información necesaria para configurar el acceso SMB para los clientes.
...
`-rootvolume-security-style`
 a| 
Use el estilo de seguridad NTFS para la SVM.
 a| 
`ntfs`
