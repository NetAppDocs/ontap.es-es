...
[role="lead"]
Si habilitaste las reglas de política de exportación SMB, la política de exportación predeterminada del volumen raíz de la SVM debe incluir una regla que permita a todos los clientes acceso abierto a través de SMB. Sin esa regla, a todos los clientes SMB se les niega el acceso a la SVM y a sus volúmenes. Las reglas de política de exportación están deshabilitadas por defecto.
...
link:../smb-admin/enable-disable-export-policies-task.html["Aprende a activar o desactivar las políticas de exportación de ONTAP para el acceso SMB"].
