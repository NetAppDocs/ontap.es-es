...
.. En el cuadro *carpeta* , escriba el nombre del servidor SMB que contiene el recurso compartido que contiene los datos a los que desea aplicar permisos y el nombre del recurso compartido.
+
