...
+
Los protocolos SCSI, NAS y NVMe pueden existir en la misma máquina virtual de almacenamiento (SVM). Si el sistema operativo del host no admite la coexistencia de protocolos, debes configurar SVM independientes para cada protocolo admitido por el host.
