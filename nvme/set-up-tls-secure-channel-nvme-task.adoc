...
summary: A partir de ONTAP 9.16.1, puedes activar y desactivar el canal seguro TLS para conexiones NVMe TCP. 
---
...
[role="lead"]
A partir de ONTAP 9.16.1, puedes configurar un canal seguro TLS para las conexiones NVMe/TCP. Puedes usar System Manager o la CLI de ONTAP para agregar un nuevo subsistema NVMe con TLS habilitado, o habilitar TLS en un subsistema NVMe ya existente. A partir de ONTAP 9.19.1, se admite la descarga de TLS en hardware.
