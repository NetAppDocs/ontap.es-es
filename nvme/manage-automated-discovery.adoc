...
summary: A partir de ONTAP 9.13.1, la detección automatizada de hosts de los controladores que utilizan el protocolo NVMe TCP es automática por defecto en los entornos basados en IP. 
---
