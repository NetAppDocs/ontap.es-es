...
https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/Hardware-assisted_(HWassist)_takeover_-_Resolution_guide["Toma de control asistida por hardware (HWassist): Guía de resolución"^]
