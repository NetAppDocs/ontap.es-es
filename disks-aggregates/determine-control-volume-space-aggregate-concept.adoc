...
`Volume Data Footprint`
 a| 
La cantidad total de espacio utilizado en el agregado contenedor por los datos de un volumen en el sistema de archivos activo y el espacio utilizado por las instantáneas del volumen. Esta fila no incluye espacio reservado.
 a| 
