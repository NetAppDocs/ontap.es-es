...
---
= Añada niveles locales manualmente en ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Al crear varios niveles locales para utilizarlos con FlexGroups, el tamaño de los niveles locales debe ser lo más parecido posible.
