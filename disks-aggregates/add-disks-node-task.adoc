...
El número mínimo de HDDs que deberías añadir en un solo procedimiento es seis. El número mínimo de SSDs que deberías añadir en un solo procedimiento es tres. Añadir una sola unidad podría reducir el rendimiento.
