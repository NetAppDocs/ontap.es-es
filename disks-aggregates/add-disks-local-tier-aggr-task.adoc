...
. Seleccione el agregado al que desea añadir discos de capacidad y haga clic en *Acciones > Añadir capacidad*.
+
...
. Selecciona *Almacenamiento > Niveles* para verificar el tamaño del nuevo agregado.
...
Este procedimiento para agregar discos particionados a un agregado es similar al procedimiento para agregar discos sin particiones.
