...
Realice esta tarea solo si ha instalado ONTAP 9.8 o una versión posterior. Si instaló una versión anterior de ONTAP, consulte la pestaña (o sección) con la etiqueta "System Manager (ONTAP 9.7 y versiones anteriores) ".
