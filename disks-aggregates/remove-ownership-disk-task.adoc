...
....
. Si el disco está particionado para la partición de datos raíz, elimine la propiedad de las particiones:
+
--
.. Para ONTAP 9.10.1 y posterior, introduzca:
+
`storage disk removeowner -disk _disk_name_`

.. Para ONTAP 9.9.1 y versiones anteriores, escriba ambos comandos:
+
