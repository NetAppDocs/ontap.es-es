...
== Funcionalidades compatibles a partir de ONTAP 9.18.1

* xref:../performance-admin/adaptive-qos-policy-groups-task.html[Políticas de QoS anidadas]son compatibles con los siguientes pares de objetos:
+
** SVM y volúmenes FlexGroup contenidos por el SVM
** Volúmenes FlexGroup y qtrees dentro de los volúmenes
...
* xref:../anti-ransomware/index.html[Protección autónoma de ransomware] para los volúmenes FlexGroup, incluyendo la siguiente funcionalidad compatible:
+
