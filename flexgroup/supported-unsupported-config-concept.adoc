...
** Reequilibrio de FlexGroup: La protección autónoma frente al ransomware se copia entre nodos durante las operaciones de reequilibrio disruptivas y no disruptivas.
