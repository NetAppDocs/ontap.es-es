...
Consulte la link:supported-unsupported-config-concept.html["Configuraciones compatibles y no compatibles para volúmenes FlexGroup"] para obtener más información.
