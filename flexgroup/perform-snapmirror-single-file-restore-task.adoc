...
* Debe limpiar una transferencia de restauración de archivos individuales con errores mediante `clean-up-failure` la opción del `snapmirror restore` comando
