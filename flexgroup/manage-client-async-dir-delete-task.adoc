...
link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously["Descubre cómo usar ONTAP para eliminar directorios de forma asíncrona de volúmenes FlexVol y FlexGroup"].
...
.Pasos
. Desde la CLI del clúster, entra en el modo de privilegios avanzados: `-privilege advanced`
