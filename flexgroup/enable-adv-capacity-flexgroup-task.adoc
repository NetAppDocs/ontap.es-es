...
* Desactiva SMB Multichannel antes de activar el reequilibrio de capacidad avanzado. Usar SMB Multichannel con reequilibrio de capacidad avanzado puede causar alta latencia. Para más información, consulta link:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-Issues/CONTAP-400433["CONTAP-400433: Alta latencia de lectura/escritura al usar FlexGroup Rebalancing/GDD sobre clientes con SMB Multichannel habilitado"].
