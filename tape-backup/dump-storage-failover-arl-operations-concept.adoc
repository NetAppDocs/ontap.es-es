...
summary: Antes de realizar operaciones de backup o restauración de volcado, debes comprender cómo funcionan estas operaciones con las operaciones de conmutación por error de almacenamiento o reubicación de agregados. La opción -override-vetoes determina el comportamiento del motor de volcado durante una operación de conmutación por error de almacenamiento o ARL. 
---
