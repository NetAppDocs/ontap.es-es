...
summary: Cuando el equilibrador automático de datos está activado, el equilibrador analiza las estadísticas de uso de los agregados para identificar el agregado que ha superado el porcentaje de uso de umbral alto configurado. 
---
