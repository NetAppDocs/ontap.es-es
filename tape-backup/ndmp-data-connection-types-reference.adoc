...
summary: En el modo NDMP con máquina virtual de almacenamiento, los tipos de conexión de datos NDMP admitidos dependen del tipo de LIF de la conexión de control NDMP y del estado de la extensión CAB. Este tipo de conexión de datos NDMP indica si puedes realizar una operación de backup o restauración NDMP local o de tres vías. 
---
