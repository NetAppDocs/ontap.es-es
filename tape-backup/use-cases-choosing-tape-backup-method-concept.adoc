...
summary: 'ONTAP admite dos motores de backup: SMTape y dump. Debes conocer los casos de uso de los motores de backup SMTape y dump para ayudarte a elegir el motor de backup para realizar las operaciones de backup en cinta y restauración.' 
---
