...
summary: La operación SMTape se interrumpe debido a una operación de conmutación por error de almacenamiento de un agregado CFO. 
---
= Error en la transferencia (interrupción iniciada por CFO)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
