...
summary: El número máximo de hilos de entrada y salida de cinta locales activos está actualmente en uso. Puedes tener un máximo de 16 unidades de cinta locales activas. 
---
