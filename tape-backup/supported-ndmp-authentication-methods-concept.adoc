...
summary: 'Puedes especificar un método de autenticación para permitir las solicitudes de conexión NDMP. ONTAP admite dos métodos para autenticar el acceso NDMP a un sistema de almacenamiento: texto sin formato y desafío.' 
---
