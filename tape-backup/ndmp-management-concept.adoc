...
summary: El protocolo de gestión de datos en red es un protocolo normalizado para controlar el backup, la recuperación y otros tipos de transferencia de datos entre dispositivos de almacenamiento primario y secundario, como sistemas de almacenamiento y bibliotecas de cintas. 
---
