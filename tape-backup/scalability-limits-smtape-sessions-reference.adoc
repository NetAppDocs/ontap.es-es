...
summary: Al realizar operaciones de copia de seguridad y restauración de SMTape a través de NDMP o CLI, debes tener en cuenta el número máximo de sesiones de copia de seguridad y restauración de SMTape que se pueden realizar simultáneamente en sistemas de almacenamiento con distintas capacidades de memoria del sistema. Este número máximo depende de la memoria del sistema de almacenamiento. 
---
= Límites de escalabilidad de ONTAP para sesiones de copia de seguridad y restauración de SMTape
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
