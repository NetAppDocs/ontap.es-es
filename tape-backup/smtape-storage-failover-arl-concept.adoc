...
summary: Antes de realizar operaciones de backup o restauración de SMTape, debes comprender cómo funcionan estas operaciones con la conmutación por error de almacenamiento o la operación de reubicación de agregados. La opción -override-vetoes determina el comportamiento del motor SMTape durante una conmutación por error de almacenamiento o una operación ARL. 
---
