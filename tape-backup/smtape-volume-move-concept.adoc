...
---
= Cómo funciona SMTape con el movimiento de volumen de ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Las operaciones de backup en cinta SMTape y las operaciones de traslado de volúmenes pueden ejecutarse en paralelo hasta que el sistema de almacenamiento intente la fase final de transición. Durante la fase final de transición, no se pueden ejecutar nuevas operaciones de backup en cinta SMTape en el volumen que se está trasladando. Sin embargo, las operaciones en curso continúan ejecutándose hasta que terminan.
