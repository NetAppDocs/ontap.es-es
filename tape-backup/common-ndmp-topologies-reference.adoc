...
summary: NDMP admite varias topologías y configuraciones entre las aplicaciones de backup y los sistemas de almacenamiento u otros servidores NDMP que proporcionan servicios de datos y cinta. 
---
