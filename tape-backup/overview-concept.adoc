...
summary: ONTAP admite backup en cinta y restauración a través de Network Data Management Protocol. NDMP te permite hacer backup de datos en sistemas de almacenamiento directamente en cinta, lo que resulta en un uso eficiente del ancho de banda de la red. ONTAP admite tanto los motores dump como SMTape para backup en cinta. 
---
