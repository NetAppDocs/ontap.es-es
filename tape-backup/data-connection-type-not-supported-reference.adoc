...
summary: En el modo NDMP con ámbito de nodo, la conexión de datos NDMP establecida debe ser del mismo tipo de dirección de red que la conexión de control NDMP. 
---
