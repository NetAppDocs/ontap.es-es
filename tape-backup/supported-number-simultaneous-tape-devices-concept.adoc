...
summary: ONTAP admite un máximo de 64 conexiones simultáneas de unidades de cinta, 16 cambiadores de soportes y 16 dispositivos de puente o enrutador para cada sistema de almacenamiento en cualquier combinación de conexiones Fibre Channel, SCSI o SAS. 
---
