...
summary: Puedes elegir realizar las operaciones de backup en cinta y restauración ya sea a nivel de nodo o a nivel de máquina virtual de almacenamiento. Para realizar estas operaciones correctamente a nivel de SVM, el servicio NDMP debe estar habilitado en la SVM. 
---
