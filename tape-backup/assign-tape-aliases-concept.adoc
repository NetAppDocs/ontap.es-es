...
summary: Aliasing simplifica el proceso de identificación de dispositivos. Aliasing vincula un nombre de ruta física o un número de serie de una cinta o un cambiador de soporte a un nombre de alias persistente, pero modificable. 
---
