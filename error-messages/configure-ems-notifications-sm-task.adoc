...
.Pasos
. Haga clic en *clúster > Configuración*.
. En la sección *Administración de notificaciones*, haga clic en image:../media/icon_kabob.gif["icono de kebab"], A continuación, haga clic en *Ver destinos de eventos*.
...
. En la sección *Administración de notificaciones*, haga clic en image:../media/icon_kabob.gif["icono de kebab"], A continuación, haga clic en *Ver destinos de eventos*.
. En la página *Administración de notificaciones*, seleccione la ficha *Destinos de eventos*.
. Junto al nombre del destino del evento, haga clic en image:../media/icon_kabob.gif["icono de kebab"], Luego haga clic en *Eliminar*.
