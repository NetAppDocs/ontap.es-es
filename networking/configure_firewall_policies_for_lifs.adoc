...
Puede usar el comando network interface modify para aplicar la política del firewall a una LIF existente. Para obtener una sintaxis completa del comando, consulte link:http://docs.netapp.com/us-en/ontap-cli["Referencia de comandos de ONTAP 9"^].
