...
....
Obtenga más información sobre `network connections listening show` en el link:https://docs.netapp.com/us-en/ontap-cli/network-connections-listening-show.html["Referencia de comandos de la ONTAP"^].
