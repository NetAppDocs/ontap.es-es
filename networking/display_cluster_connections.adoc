...
summary: Ver todas las conexiones activas o a la escucha en el clúster o un recuento de las conexiones activas en el nodo por cliente, LIF, protocolo o servicio. 
---
...
Obtén más información sobre `network connections active show-protocols` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=network+connections+active+show-protocols["Referencia de comandos del ONTAP"^].
