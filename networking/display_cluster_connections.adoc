...
Para obtener más información acerca de este comando, consulte link:http://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-clients.html["Referencia de comandos de ONTAP 9"^].
