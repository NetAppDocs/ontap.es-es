...
Para obtener más información acerca de este comando, consulte la link:http://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-clients.html["Referencia de comandos de la ONTAP"^].
...
Para obtener más información sobre este comando, consulte la página man: https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html["Referencia de comandos de la ONTAP"^]
