...
summary: Configura SNMP para supervisar las SVM de tu clúster. 
---
...
Para obtener más información sobre la compatibilidad con SNMP en los sistemas ONTAP, consulta https://www.netapp.com/pdf.html?item=/media/16417-tr-4220.pdf["TR-4220: Compatibilidad con SNMP en Data ONTAP"^].
