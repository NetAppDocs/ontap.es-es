...
summary: Cambia la dirección de subred, el valor de la máscara, la dirección de la puerta de enlace o el rango de direcciones IP. 
---
= Cambiar las propiedades de la subred de ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
