...
|===
Para obtener más información acerca de `vserver services name-service dns hosts` comandos, consulte link:http://docs.netapp.com/us-en/ontap-cli["Referencia de comandos de ONTAP 9"^].
