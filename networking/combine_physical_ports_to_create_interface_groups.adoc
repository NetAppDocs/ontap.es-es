...
Obtenga más información acerca de `network port ifgrp add-port` las restricciones de configuración que se aplican a los grupos de interfaces de puertos en link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Referencia de comandos de la ONTAP"^].
...
Obtenga más información sobre `network port ifgrp create` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-create.html["Referencia de comandos de la ONTAP"^].
...
Obtenga más información sobre `network port ifgrp add-port` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Referencia de comandos de la ONTAP"^].
...
Obtenga más información sobre `network port ifgrp remove-port` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-remove-port.html["Referencia de comandos de la ONTAP"^].
...
Obtenga más información sobre `network port ifgrp delete` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Referencia de comandos de la ONTAP"^].
