...
Obtenga más información sobre `network port ifgrp add-port` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Referencia de comandos de la ONTAP"^]. Obtenga más información sobre `network port ifgrp add-port` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["Referencia de comandos de la ONTAP"^].
...
Obtenga más información sobre `network port ifgrp delete` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Referencia de comandos de la ONTAP"^]. Obtenga más información sobre `network port ifgrp delete` en el link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["Referencia de comandos de la ONTAP"^].
