...
summary: Usa DNS para acceder a fuentes locales o remotas de información sobre hosts. 
---
= Configura DNS para la resolución de nombres de host en ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
