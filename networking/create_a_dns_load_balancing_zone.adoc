...
Si ya existe la zona de equilibrio de carga, se agrega el LIF. Para obtener más información acerca del comando, consulte link:http://docs.netapp.com/us-en/ontap-cli["Referencia de comandos de ONTAP 9"^].
