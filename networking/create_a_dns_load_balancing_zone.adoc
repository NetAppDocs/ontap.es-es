...
.Paso
Utilice `network interface create` el comando con `dns-zone` la opción para crear una zona de equilibrio de carga DNS. Obtenga más información sobre `network interface create` en el link:https://docs.netapp.com/us-en/ontap-cli/network-interface-create.html["Referencia de comandos de la ONTAP"^].
