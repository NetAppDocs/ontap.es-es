...
summary: Modifica el valor de MTU para un dominio de difusión para cambiar ese valor para todos los puertos en el dominio de difusión. 
---
...
.System Manager
--
A partir de ONTAP 9.12.0, puedes usar System Manager para modificar el valor de MTU de un dominio de difusión y así cambiar el valor de MTU de todos los puertos en ese dominio de difusión.
