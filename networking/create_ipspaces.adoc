...
summary: Crea espacios IP para cada SVM en un clúster. 
---
...
[NOTE]
====
A partir de ONTAP 9.19.1, ONTAP mejora el rendimiento de la transferencia de datos TCP a través de enlaces WAN con pérdidas y alta latencia mediante la integración de dos funciones de recuperación de pérdidas en la pila TCP de ONTAP: PRR y RACK. link:improve-tcp-wan-performance.html["Descubre cómo mejorar el rendimiento de TCP en la WAN con PRR y RACK"]
