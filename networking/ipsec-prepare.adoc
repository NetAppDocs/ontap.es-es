...
|===
Obtenga más información sobre la API de REST DE ONTAP, incluidas https://docs.netapp.com/us-en/ontap-automation/whats-new.html["Novedades de la API DE REST de ONTAP"^], en el sitio de documentación de la automatización de ONTAP. También debe consultar la documentación de ONTAP https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html["Referencia API"^] para obtener más información sobre los puntos finales de IPsec.
