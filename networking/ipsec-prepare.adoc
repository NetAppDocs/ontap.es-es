...
Debe instalar y utilizar solo tarjetas Ethernet compatibles. Las siguientes tarjetas Ethernet son compatibles con ONTAP 9.16.1 en las siguientes plataformas. Consulte la link:https://hwu.netapp.com/["Hardware Universe de NetApp"^] para obtener más información sobre las plataformas y tarjetas compatibles.
