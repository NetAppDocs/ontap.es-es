...
summary: Si se vuelve a cablear un puerto o cambia la configuración del switch, puede que sea necesario reparar un puerto en un dominio de difusión diferente, nuevo o existente. 
---
