...
|===
Para obtener más información acerca de `system snmp`, `security`, y. `event` comandos, consulte link:http://docs.netapp.com/us-en/ontap-cli["Referencia de comandos de ONTAP 9"^].
