...
+
Además, puede habilitar manualmente la conmutación por error de LIF iSCSI en LIF iSCSI preexistentes, es decir, LIF que se crearon antes de la actualización a ONTAP 9.11.1 o posterior.
