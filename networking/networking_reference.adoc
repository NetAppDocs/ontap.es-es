...
Para comprender el impacto de las funciones de red disponibles con cada versión de ONTAP 9, consulte la link:../ontap/release-notes/index.html["Notas de la versión de ONTAP"].
