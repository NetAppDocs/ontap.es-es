...
summary: Utiliza protocolos de descubrimiento de vecinos para ver la conectividad de red entre un par de sistemas físicos o virtuales y sus interfaces de red. 
---
= Protocolos de descubrimiento de vecinos para la conectividad de red de ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
