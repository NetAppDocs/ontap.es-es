...
summary: El control del estado automático y un conjunto de monitores de estado te ayudan a identificar los puertos de red que podrían no ser adecuados para alojar LIFs. 
---
