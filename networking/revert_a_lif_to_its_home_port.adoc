...
summary: Revierte un LIF a su puerto de origen después de que se produzca una conmutación por error o se migre. 
---
= Revertir un LIF a su puerto de origen en ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
