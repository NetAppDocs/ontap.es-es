...
Obtenga más información sobre `vlan create` en el link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=vlan+create["Referencia de comandos de la ONTAP"^].
