...
También debes habilitar LLDP en todos los switches y routers Ethernet antes de que se pueda mostrar la información sobre los dispositivos vecinos.
...
* La información mostrada puede variar entre el clúster y el conmutador Ethernet.
+
Los datos de Chassis ID y Port ID que muestra el conmutador Ethernet pueden ser diferentes para los puertos CNA y los que no son CNA.
