...
summary: Los dominios de difusión, los grupos de conmutación por error y las políticas de conmutación por error funcionan conjuntamente para determinar qué puerto tomará el control en caso de fallo. 
---
= Cómo funcionan los dominios de difusión, los grupos de conmutación por error y las políticas de ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
