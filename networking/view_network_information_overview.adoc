...
summary: Ver y descargar información relacionada con puertos, LIFs, rutas, reglas de conmutación por error, grupos de conmutación por error, reglas de cortafuegos, DNS, NIS y conexiones. 
---
= Información de red que puedes consultar en ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
