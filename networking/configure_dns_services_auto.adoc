...
NOTE: Para evitar un fallo de configuración de un FQDN de SVM que no cumpla las reglas RFC para actualizaciones DDNS, usa un nombre FQDN que sí cumpla las reglas RFC. Para más información, consulta link:https://tools.ietf.org/html/rfc1123["RFC 1123"^].
