...
-
 a| 
Servicios para acceso de gestión HTTP
...
-
 a| 
Se introdujo en ONTAP 9.11.1. Servicios para el acceso de gestión de servidores NTP
...
-
 a| 
A partir de ONTAP 9.11.1, ONTAP proporciona servicio de cliente DNS para conexiones salientes con un servidor DNS externo.
