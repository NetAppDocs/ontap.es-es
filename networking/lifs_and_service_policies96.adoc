...
summary: Asigna políticas de servicio a los LIF para especificar el tráfico admitido. 
---
= Políticas de servicio de ONTAP LIF
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
IMPORTANT: Los protocolos FCP y NVMe/FCP no requieren actualmente una service-policy.
...
NOTE: Las aplicaciones en una LIF con una política de servicio vacía podrían comportarse inesperadamente.
