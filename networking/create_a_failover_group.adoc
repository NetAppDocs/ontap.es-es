...
summary: Crea un grupo de conmutación por error de puertos de red para migrar automáticamente un LIF a un puerto diferente cuando se produce un fallo de enlace. 
---
