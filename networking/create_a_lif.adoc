...
+
Obtenga más información sobre `network ndp prefix show` en el link:https://docs.netapp.com/us-en/ontap-cli/network-ndp-prefix-show.html["Referencia de comandos de la ONTAP"^].
