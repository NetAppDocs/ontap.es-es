...
summary: Agrega direcciones IP al crear una subred o agrega o elimina direcciones IP en una subred existente. 
---
= Agregar o eliminar direcciones IP de una subred de ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
