...
+
.. Elige si quieres activar link:../concepts/thin-provisioning-concept.html["*Thin Provisioning*"].
...
. Para clonar el grupo de consistencia en su estado actual, elija *Agregar una nueva instantánea*.
+
