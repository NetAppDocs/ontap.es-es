...
Las snapshots de grupo de consistencia creadas en la API de REST pueden gestionarse a través de la interfaz del grupo de consistencia de System Manager y mediante extremos de la API de REST del grupo de consistencia.
