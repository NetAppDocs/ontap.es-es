...
[role="lead"]
A partir de ONTAP 9.10.1, puedes aplicar el bloqueo global de archivos en los volúmenes de FlexCache para evitar lecturas en todos los archivos en caché relacionados.
