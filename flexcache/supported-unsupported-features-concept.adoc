...
Compatible a partir de ONTAP 9.5.  El SVM primario de una relación SVM DR puede tener el volumen de origen; sin embargo, si se rompe la relación SVM DR, la relación FlexCache debe recrearse con un nuevo volumen de origen.
 a| 
No
