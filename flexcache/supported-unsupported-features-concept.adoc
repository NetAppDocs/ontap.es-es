...
Compatible a partir de ONTAP 9.18.1
...
No
 ...
 a| 
SnapMirror relaciones asíncronas
 a| 
Sí

Más información sobre los orígenes de FlexCache:
...
Puedes tener volúmenes de origen FlexCache en las SVM primarias, pero no en las SVM secundarias. La relación FlexCache no se replica, pero los datos del volumen de origen se replican como un volumen normal.
...
NOTE: En las versiones de ONTAP 9 anteriores a la 9.5, los volúmenes de origen FlexVol solo pueden proporcionar datos a volúmenes FlexCache creados en sistemas que ejecutan Data ONTAP 8.2.x en 7-Mode. A partir de ONTAP 9.5, los volúmenes de origen FlexVol también pueden proporcionar datos a volúmenes FlexCache en sistemas ONTAP 9. Para obtener información sobre la migración de 7-Mode FlexCache a ONTAP 9 FlexCache consulta link:https://www.netapp.com/pdf.html?item=/media/7336-tr4743.pdf["Informe técnico de NetApp 4743: FlexCache en ONTAP"^].
