...
* Si utiliza ONTAP 9,6 o una versión anterior, debe link:add-license-task.html["Añadir una licencia de FlexCache"].
+
No se requiere una licencia de FlexCache para ONTAP 9,7 o una versión posterior.
