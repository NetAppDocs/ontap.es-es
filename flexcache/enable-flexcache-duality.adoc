...
NOTE: Para una documentación más completa sobre la dualidad de FlexCache, consulta link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works["Soporte multiprotocolo de ONTAP S3"^].
