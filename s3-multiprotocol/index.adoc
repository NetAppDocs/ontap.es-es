...
NOTE: Los objetos multiparte en los buckets NAS de S3 deben alinearse en tamaños enteros, no parciales. Por ejemplo, una parte puede ser de 4MB o 4GB o un tamaño similar. Una parte no puede usar tamaños parciales o menores a 1MB, como 4.5MB o 4000.5MB.
...
* CopyObject no es compatible en volúmenes SnapLock
