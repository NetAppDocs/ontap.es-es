...
NOTE: Estas acciones de S3 no son específicamente compatibles cuando se utiliza S3 en bloques NAS de S3. Cuando se utilizan cubos S3 nativos, estas acciones son link:../s3-config/ontap-s3-supported-actions-reference.html["compatible con normalidad"].
